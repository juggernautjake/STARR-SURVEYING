...
//
// `app/credentials/page.tsx` is a `'use client'` component, and a client component cannot export
...
export const metadata: Metadata = pageMetadata({
  title: 'RPLS Licensed & Insured Land Surveyors',
  description:
    'Starr Surveying is owned and operated by a Registered Professional Land Surveyor licensed by TBPELS. Verify our RPLS licence, insurance and professional standards.',
  path: '/credentials',
});
