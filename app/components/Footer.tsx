            ...
            <div className="footer__reviews-content">
              ...
              <div className="footer__reviews-actions">
                ...
                >
                  {copied ? (
                    <>
                      <svg className="footer__reviews-copy-icon" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    ...
                    <>
                      <svg className="footer__reviews-copy-icon" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
