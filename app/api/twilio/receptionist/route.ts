...
//
// So: every call to the toll-free number is dialled straight through to the owner's cell. His leg
// gets a short whisper ("press any key to accept") — see ./screen — which is what makes this work
// when HIS carrier voicemail answers instead of him: nobody presses a key, the leg is dropped, and
// Twilio reports no-answer. Either way, ./after-dial decides what happens next: a completed call
// just ends; anything else hands the caller to the AI receptionist.
//
