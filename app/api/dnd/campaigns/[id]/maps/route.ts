...
export async function DELETE(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  // Free the bytes (P2-7). Without this the quota only ever rises and every active account is eventually
  // locked out permanently — a failure that looks fine for months and then hits everyone at once.
