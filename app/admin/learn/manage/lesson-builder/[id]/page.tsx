...
import {
  BLOCK_TYPES, convertToEmbedUrl, formatFileSize, getDefaultContent, parseHtmlToBlocks, renderLatex,
  type BlockStyle, type BlockType, type LessonBlock, type LessonMeta,
} from './blocks';
  ...
  return (
    <div className="lesson-builder">
      ...
      {previewMode ? (
        <LessonPreview
          blocks={blocks}
          getBlockRows={getBlockRows}
          dhtml={dhtml}
          slideshowIndexes={slideshowIndexes}
          ...
          setExpandedPopups={setExpandedPopups}
          flashcardIndexes={flashcardIndexes}
          setFlashcardIndexes={setFlashcardIndexes}
          quizAnswers={quizAnswers}
          setQuizAnswers={setQuizAnswers}
          quizRevealed={quizRevealed}
          setQuizRevealed={setQuizRevealed}
          previewTabIndexes={previewTabIndexes}
          setPreviewTabIndexes={setPreviewTabIndexes}
          previewAccordionOpen={previewAccordionOpen}
          setPreviewAccordionOpen={setPreviewAccordionOpen}
        />
      ) : (
        /* Edit Mode */
