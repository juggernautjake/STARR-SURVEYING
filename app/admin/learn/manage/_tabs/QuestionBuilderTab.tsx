// app/admin/learn/manage/_tabs/QuestionBuilderTab.tsx — a tab of the Learning Content portal.
//
// C12d / P19. Was `/admin/learn/manage/question-builder/page.tsx`; the old route stays and
// forwards. 1,862 lines, and not one of them changed.
...
export default function QuestionBuilderTab({ onBack }: { onBack: () => void }) {
  ...
  return (
    <>
      ...
      <div className="learn__header">
        {/* C12d: was a <Link> to `/admin/learn/manage?tab=questions`. That was a different ROUTE
          * until this slice, so the page remounted and re-read `?tab=`. Same route now: Next soft-
          * navigates, nothing remounts, `useState(initialTab)` never runs again, and the link would
          * change the URL while the screen stayed on the builder. Switching tabs is the page's job. */}
        <button type="button" className="learn__back" onClick={onBack}
