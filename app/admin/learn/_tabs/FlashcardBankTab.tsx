// app/admin/learn/_tabs/FlashcardBankTab.tsx — a tab of the Knowledge portal.
//
// C11a / P12 of §8 in docs/planning/completed/PAGE_CONSOLIDATION_2026-08-24.md. Was
// `/admin/learn/flashcard-bank/page.tsx`; the old route stays and forwards.
//
...
export default function FlashcardBankTab() {
