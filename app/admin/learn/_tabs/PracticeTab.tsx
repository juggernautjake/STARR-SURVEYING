// app/admin/learn/_tabs/PracticeTab.tsx — a tab of the Knowledge portal.
//
// C11a / P12 of §8 in docs/planning/in-progress/PAGE_CONSOLIDATION_2026-08-24.md. Was
// `/admin/learn/practice/page.tsx`; the old route stays and forwards.
//
  ...
  if (phase === 'setup') return (
    <>
      <div className="learn__header">
        {/* C11a: a "← Back to Learning Hub" link sat here. This IS the Learning Hub now — the link
          * pointed at the portal it is rendered inside, which lands you on the Hub tab and reads as a
          * bug. Eight of the ten absorbed bodies carried one. The tab strip is the way back. */}
  ...
  if (phase === 'results' && summary) return (
    <>
      ...
      <div style={{ display: 'flex', gap: '.75rem', marginTop: '1.5rem' }}>
        ...
        {/* C11a: and a second one here, on the results screen. "New Practice Session" beside it is a
          * real action; this was a link back to the page it was already on. */}
      </div>
    </>
  );
