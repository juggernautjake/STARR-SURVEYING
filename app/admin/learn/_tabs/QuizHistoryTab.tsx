// app/admin/learn/_tabs/QuizHistoryTab.tsx — a tab of the Knowledge portal.
//
// C11a / P12 of §8 in docs/planning/in-progress/PAGE_CONSOLIDATION_2026-08-24.md. Was
// `/admin/learn/quiz-history/page.tsx`; the old route stays and forwards.
//
