// app/admin/learn/_tabs/ReferencesTab.tsx — a tab of the Knowledge portal.
//
// C11a / P12 of §8 in docs/planning/completed/PAGE_CONSOLIDATION_2026-08-24.md. Was
// `/admin/learn/references/page.tsx`; the old route stays and forwards.
//
  ...
  return (
    <div style={{ maxWidth: 860, margin: '0 auto', padding: '24px 20px 60px' }}>
      <Link href="/admin/learn/exam-prep/sit" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, color: 'var(--muted, #64748b)', textDecoration: 'none', fontSize: 13, marginBottom: 12 }}>
        {/* C11a: this one is NOT a self-link — /admin/learn/exam-prep/sit is a different route and
          * deliberately unabsorbed. What stopped being true is the ARROW: the library is a tab of
          * Learning now, so nobody arrives here FROM exam prep by default and "back" misdescribes
          * where the link goes. Same shape as C9's "← New Email", and the same fix. */}
        FS exam prep <ArrowRight size={15} />
      </Link>
