'use client';
// app/admin/learn/fieldbook/FieldbookPanel.tsx
//
// Extracted body of /admin/learn/fieldbook (full-page fieldbook viewer
// with categories, search, audio playback) for reuse in the Hub at
// /admin/me?tab=fieldbook (admin-nav redesign Phase 2 slice 2b/6).
...
export default function FieldbookPanel() {
  /* ─── State ─── */
