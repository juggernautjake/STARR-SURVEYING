...
export const PAGE_TITLES: Record<string, string> = {
  ...
  '/admin/pay?tab=rewards': 'Rewards & Store',
  '/admin/pay?tab=how-rewards-work': 'How Rewards Work',
  '/admin/rewards/store': 'Company Store',
  '/admin/pay?tab=rewards-admin': 'Manage Rewards',
