// app/admin/finances/reconcile/page.tsx — absorbed by a C8 portal.
//
...
// the bank queue is linked from a receipt that did not match.

import { redirect } from 'next/navigation';

export default function Page() {
  redirect('/admin/finances?tab=reconcile');
}
