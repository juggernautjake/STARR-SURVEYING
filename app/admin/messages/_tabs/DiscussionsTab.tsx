// app/admin/messages/_tabs/DiscussionsTab.tsx — a tab of the Messages portal.
//
// C13b of §4's addendum. Was /admin/discussions/page.tsx; the old route stays and forwards.
//
// §5 costs exactly nothing here, which is rare enough to note: /admin/discussions and
// /admin/messages have the SAME eight-role middleware entry, and neither row carried a `roles`
// list. The door does not move and no role list moves with it.
//
// §2.5 grouped both under "Talking to people" and said the fix for twelve comms surfaces was not
// fewer pages but a way to tell which page answers which question. This is the fewer-pages half,
// and the tab hints keep the distinction the descriptions carried.
