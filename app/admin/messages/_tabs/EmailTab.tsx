  ...
  return (
    <div className="email-compose" data-testid="email-sent-page">
      <header className="email-compose__header">
        {/* C9: "← New Email" lived here — a back-arrow on a link that went FORWARD to the composer.
          * The portal toolbar offers "Compose email" on this tab, so the duplicate went rather than
          * the arrow: two controls for one action is how one of them ends up stale. */}
