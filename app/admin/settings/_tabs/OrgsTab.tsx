// app/admin/settings/_tabs/OrgsTab.tsx — a tab of the Company portal.
//
// C12b / P14. Was `/admin/orgs/page.tsx`; the old route stays and forwards.
//
// Its registry row carried admin AND tech_support, one wider than every other tab here, and the
// tab carries that pair rather than the portal's `admin`. See the portal header: the door is
// admin-only either way, so the pair is a courtesy that currently grants nobody anything — kept
// because it is the row's own statement about who this is for, and dropping it silently would
// lose that if the door ever moves.
'use client';
