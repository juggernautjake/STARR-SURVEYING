...
const PHASE_2_SLICES: SliceRow[] = [
  ...
  { id: '7', label: 'Schema: financial_allocation_categories + financial_allocations + default seed', state: 'planned',
    detail: 'every category from the user list + the §2.2 additions (insurance, vehicle, etc.).' },
  { id: '8', label: 'Allocation engine (pure splitter)', state: 'planned',
    detail: 'split a payment by target %, last category absorbs rounding remainder.' },
  ...
  { id: '10', label: 'Reports: /admin/invoicing/reports', state: 'planned',
    detail: 'target vs actual per category + revenue per period + outstanding invoices.' },
