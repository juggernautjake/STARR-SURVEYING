  ...
  return (
    <Shell>
      <header style={styles.header}>
        <div>
          {/* C8: a "back to the portal" link stood here. Inside a tab OF that portal it points at
            * the page you are standing on — a no-op navigation that reads as broken. The tab strip
            * above is the way back to everything else. */}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  back: { color: 'var(--theme-fg-secondary, #6B7280)', textDecoration: 'none', fontSize: '0.82rem' },
  header: { marginBottom: '1.25rem' },
  h1: { fontFamily: 'Sora, sans-serif', fontSize: '1.65rem', margin: '0.4rem 0 0.4rem', fontWeight: 600 },
  subtitle: { color: 'var(--theme-fg-secondary, #4B5563)', margin: 0, fontSize: '0.92rem', lineHeight: 1.55 },
  errorBanner: {
  ...
  th: {
    ...
    textTransform: 'uppercase', color: 'var(--theme-fg-secondary, #4B5563)', fontWeight: 600, letterSpacing: 0.04,
  },
  thRight: {
  ...
  tdKey: { color: 'var(--theme-fg-secondary, #6B7280)', fontSize: '0.74rem', fontFamily: 'JetBrains Mono, ui-monospace, monospace' },
  ...
  btnGhost: { background: '#FFFFFF', color: 'var(--theme-fg-secondary, #374151)', borderColor: '#E5E7EB' },
  btnPrimary: { background: '#1D3095', color: '#FFFFFF' },
  muted: { color: 'var(--theme-fg-secondary, #6B7280)', fontSize: '0.85rem' },
  gate: {
