'use client';
// app/admin/my-pay/MyPayPanel.tsx
//
// Extracted body of /admin/my-pay for reuse in the Hub at
// /admin/me?tab=pay (admin-nav redesign Phase 2 slice 2b/5).
...
export default function MyPayPanel() {
