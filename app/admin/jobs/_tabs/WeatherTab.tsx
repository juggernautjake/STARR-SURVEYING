...
//
// /admin/weather had NO middleware entry — any signed-in account could type it — and its API
// checks only that you are signed in. As a tab it sits under /admin/jobs, which middleware gates
// to five roles, and the tab carries its old row's four. So this is a NARROWING, of a path the
// nav never offered to the roles losing it. Recorded because §5 cuts both ways and a quiet
// narrowing is the harder one to notice.
...
export default function WeatherTab(): React.ReactElement {
