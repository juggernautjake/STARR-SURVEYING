...
//
// ── WHY THIS ONE IS THE RIGHT MERGE AND THE OTHER TWO IN §4 ARE NOT ─────────────────────────
//
// Four pages in this plan have been stopped at the personal-vs-company line: a personal surface
// folded into a company page gated more narrowly disappears for the people it is for. This is the
// opposite case, and it is why it goes ahead: assignments is ALREADY personal — the API scopes a
// non-admin to `.eq('assigned_to', session.user.email)`, so you see your own work and nobody
// else's — and the Hours portal is already the `hub` workspace's personal surface. Personal into
// personal, which is what §4 meant by "the same session".
//
// The door widens: /admin/assignments has its own six-role middleware entry and /admin/hours has
// none. The tab carries the six verbatim, and the row filter above is what actually decides.
