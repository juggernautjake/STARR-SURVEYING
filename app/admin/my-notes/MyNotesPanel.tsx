'use client';
// app/admin/my-notes/MyNotesPanel.tsx
//
// Extracted body of /admin/my-notes (Fieldbook-API-backed personal /
// job-notes tabs) for reuse in the Hub at /admin/me?tab=notes
// (admin-nav redesign Phase 2 slice 2b/6).
