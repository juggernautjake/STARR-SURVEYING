  ...
  return (
    <div className="rr">
      ...
      <style jsx>{`
        ...
        .rr__lead { margin: 0 0 1.2rem; font-size: 0.88rem; color: var(--theme-fg-tertiary, #6B7280); }
        ...
        .rr__muted { margin: 0; font-size: 0.85rem; color: var(--theme-fg-tertiary, #6B7280); }
        ...
        .rr__role--on { border-color: var(--color-brand-navy, #1E3A5F); background: var(--theme-bg-subtle, #F4F7FB); }
        ...
        .rr__role em { font-style: normal; font-size: 0.74rem; color: var(--theme-fg-tertiary, #6B7280); overflow-wrap: anywhere; }
        ...
        .rr__reason { font-size: 0.76rem; color: var(--theme-fg-tertiary, #6B7280); overflow-wrap: anywhere; }
