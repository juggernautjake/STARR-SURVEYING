...
const FORMAT_OPTIONS: {
  ...
  },
  {
    ...
    icon: '\uD83D\uDDBC\uFE0F',
    available: true,
    tip: 'Export as a 300-DPI PNG image. Best for printing and sharing.',
  },
  {
    format: 'pdf',
    label: 'PDF',
    ...
    icon: '\uD83D\uDCCB',
    available: true,
    tip: 'Export as a print-ready PDF. Use for final deliverables and client reports.',
  },
  {
    format: 'dxf',
    label: 'DXF',
    ...
    icon: '\uD83D\uDCD0',
    available: true,
    tip: 'Export as AutoCAD DXF with feature-class layers. Open in AutoCAD, Civil 3D, or QGIS.',
  },
];
