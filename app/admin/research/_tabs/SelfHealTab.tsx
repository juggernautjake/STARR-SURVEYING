...
export default function SelfHealTab(): React.ReactElement {
...
const styles: Record<string, React.CSSProperties> = {
  ...
  settingLabel: { display: 'block', fontWeight: 600, fontSize: '0.98rem', color: 'var(--theme-fg-primary, #1F2937)' },
  settingDescription: { display: 'block', marginTop: 4, fontSize: '0.85rem', color: 'var(--theme-fg-secondary, #6B7280)', lineHeight: 1.5 },
  ...
  toggleText: { fontSize: '0.85rem', fontWeight: 600, color: 'var(--theme-fg-secondary, #374151)', minWidth: 30 },
  ...
  disabledHint: { fontSize: '0.82rem', color: 'var(--theme-fg-secondary, #6B7280)' },
  results: { marginTop: '1.25rem', display: 'flex', flexDirection: 'column', gap: '1rem' },
  resultsLede: { margin: 0, fontSize: '0.95rem' },
  resultsMeta: { color: 'var(--theme-fg-secondary, #6B7280)', fontWeight: 400 },
  ...
  attentionTitle: { margin: '0.5rem 0 0', fontSize: '1rem', fontWeight: 700, color: 'var(--theme-fg-primary, #1F2937)' },
  healthyDetails: { borderTop: '1px solid #F3F4F6', paddingTop: '0.5rem' },
  healthySummary: { cursor: 'pointer', fontSize: '0.9rem', color: 'var(--theme-fg-secondary, #4B5563)', fontWeight: 600, padding: '0.4rem 0' },
  ...
  rowCounty: { fontWeight: 700, color: 'var(--theme-fg-primary, #1F2937)' },
  rowSiteType: { color: 'var(--theme-fg-secondary, #6B7280)' },
  rowVendor: { color: 'var(--theme-fg-secondary, #6B7280)' },
  rowMeta: { marginLeft: 'auto', color: 'var(--theme-fg-secondary, #6B7280)', fontSize: '0.78rem', fontFamily: 'SF Mono, Menlo, monospace' },
  rowSummary: { margin: '0.45rem 0 0.3rem', fontSize: '0.88rem', color: 'var(--theme-fg-secondary, #374151)', lineHeight: 1.5 },
  rowUrl: { fontSize: '0.78rem', color: '#1D3095', textDecoration: 'none', wordBreak: 'break-all' },
  empty: { fontSize: '0.9rem', color: 'var(--theme-fg-secondary, #6B7280)' },
  inlineLink: { color: '#1D3095', textDecoration: 'underline' },
  muted: { color: 'var(--theme-fg-secondary, #6B7280)', fontSize: '0.9rem', margin: 0 },
