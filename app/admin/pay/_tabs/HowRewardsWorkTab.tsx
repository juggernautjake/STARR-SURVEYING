  ...
  return (
    <>
      <div className="admin-learn__header">
        <Link href="/admin/pay?tab=rewards" className="admin-module-detail__back">&larr; Back to Rewards</Link>
      ...
      <div className="hiw__cta-row" style={{ textAlign: 'center', margin: '2rem 0', display: 'flex', justifyContent: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
        <Link href="/admin/pay?tab=rewards" className="admin-btn admin-btn--primary">
          Go to Rewards Store
        </Link>
