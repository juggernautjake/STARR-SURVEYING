...
//
// Extracted body of /admin/my-files for reuse in the Hub's
// `?tab=files` (admin-nav redesign Phase 2 slice 2b/3). Behaviour
// matches the legacy page; once slice 2c lands, the legacy route
// redirects here.
