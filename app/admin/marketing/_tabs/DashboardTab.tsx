  ...
  return (
    <div className="mk">
      ...
      <style jsx>{`
        ...
        .mk__panel--meter { border-color: var(--theme-border-strong, #c7d2fe); background: var(--theme-bg-elevated, #f8faff); }
        ...
        .mk__warn { background: var(--theme-bg-elevated, #fffbeb); border: 1px solid var(--theme-warning, #fde68a);
        ...
        .mk__stagebar span { position: absolute; inset: 0 auto 0 0; background: var(--theme-bg-elevated, #dbeafe);
          border-radius: 4px; }
        ...
        select, input { padding: 8px 10px; border: 1px solid var(--theme-border, #d1d5db); border-radius: 8px;
          font: inherit; min-height: 40px; background: var(--theme-bg-surface, #fff);
