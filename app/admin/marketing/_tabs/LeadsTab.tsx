...
// and is untouched.
//
// The body did not change beyond the three relative imports the extra directory level costs and
// the component name. Same reason as A1: re-arranging and rewriting in one slice makes a
