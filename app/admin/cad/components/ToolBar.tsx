  ...
  return [
    {
      ...
      variants: [
        { tool: 'SELECT', label: 'Select (click / drag)', description: 'Click a feature to select it, drag to move it. Drag empty space for a box select: left-to-right = window (fully enclosed), right-to-left = crossing (any overlap). Shift+click to toggle.', shortcut: 'S', icon: <MousePointer2 size={14} /> },
      ],
    },
    {
      mainTool: 'PAN',
