...
const PAGES: Record<string, ComponentType> = {
  ...
  team: nextDynamic(() => import('@/app/admin/hours/_tabs/TeamTab'), { ssr: false }),
  ...
  discussions: nextDynamic(() => import('@/app/admin/messages/_tabs/DiscussionsTab'), { ssr: false }),
  ...
  'learn-modules': nextDynamic(() => import('@/app/admin/learn/_tabs/ModulesTab'), { ssr: false }),
