...
//
// `app/service-area/page.tsx` is a `'use client'` component, and a client component cannot export
...
export const metadata: Metadata = pageMetadata({
  title: 'Service Area — Central Texas Counties',
  description:
    'Starr Surveying covers Central Texas within roughly 150 miles of Belton, including Bell, McLennan, Williamson, Travis, Coryell and Falls counties. See the full county list.',
  path: '/service-area',
});
