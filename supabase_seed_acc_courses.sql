...
VALUES
  -- Week 1
  ('acc01w01-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 2
  ('acc01w02-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 3
  ('acc01w03-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 4
  ('acc01w04-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 5
  ('acc01w05-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 6
  ('acc01w06-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 7
  ('acc01w07-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  ('acc01w08-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
   'Week 8: Midterm Exam',
  ...
  -- Week 9
  ('acc01w09-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 10
  ('acc01w10-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
   'Week 10: Traversing',
  ...
  -- Week 11
  ('acc01w11-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 12
  ('acc01w12-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 13
  ('acc01w13-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 14
  ('acc01w14-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 15
  ('acc01w15-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
  ...
  -- Week 16: FINAL EXAM
  ('acc01w16-0000-0000-0000-000000000001', 'acc00001-0000-0000-0000-000000000001',
   'Week 16: Final Exam',
...
VALUES
  -- Week 1
  ('acc02w01-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 2
  ('acc02w02-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 3
  ('acc02w03-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 4
  ('acc02w04-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 5
  ('acc02w05-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 6
  ('acc02w06-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 7
  ('acc02w07-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  ('acc02w08-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
   'Week 8: Midterm Practical Exam',
  ...
  -- Week 9
  ('acc02w09-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 10
  ('acc02w10-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 11
  ('acc02w11-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 12
  ('acc02w12-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 13
  ('acc02w13-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 14
  ('acc02w14-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  -- Week 15
  ('acc02w15-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
  ...
  ('acc02w16-0000-0000-0000-000000000001', 'acc00002-0000-0000-0000-000000000002',
   'Week 16: Final Practical Exam',
...
VALUES
  -- Week 1
  ('acc03w01-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 2
  ('acc03w02-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 3
  ('acc03w03-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 4
  ('acc03w04-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 5
  ('acc03w05-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 6
  ('acc03w06-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 7
  ('acc03w07-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 8: MIDTERM EXAM
  ('acc03w08-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
   'Week 8: Midterm Exam',
  ...
  -- Week 9
  ('acc03w09-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 10
  ('acc03w10-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 11
  ('acc03w11-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 12
  ('acc03w12-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 13
  ('acc03w13-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 14
  ('acc03w14-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 15
  ('acc03w15-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
  ...
  -- Week 16: FINAL EXAM
  ('acc03w16-0000-0000-0000-000000000001', 'acc00003-0000-0000-0000-000000000003',
   'Week 16: Final Exam',
...
('What is the primary purpose of a boundary survey?', 'multiple_choice', '["To create a topographic map","To establish or retrace property lines and corners","To design a road alignment","To measure elevations for drainage"]'::jsonb, 'To establish or retrace property lines and corners', 'A boundary survey (also called cadastral survey) is specifically designed to establish, retrace, or reestablish property lines and corners based on deed descriptions and survey evidence.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w01-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-1','quiz','survey-types']),
('Which ancient civilization is credited with some of the earliest known surveying, using it to re-establish farm boundaries after Nile floods?', 'multiple_choice', '["Roman Empire","Ancient Greece","Ancient Egypt","Mesopotamia"]'::jsonb, 'Ancient Egypt', 'Ancient Egyptians (called harpedonaptae or rope-stretchers) are credited with early surveying to re-establish land boundaries after annual Nile floods washed away markers. They used ropes, plumb bobs, and right-angle triangles.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w01-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-1','quiz','history']),
('A geodetic survey differs from a plane survey primarily because it:', 'multiple_choice', '["Uses more expensive equipment","Accounts for the curvature of the earth","Is performed only by government agencies","Measures only horizontal distances"]'::jsonb, 'Accounts for the curvature of the earth', 'Geodetic surveys account for the curvature of the earth and operate over large areas where the flat-earth assumption of plane surveying introduces unacceptable errors. Plane surveys treat the earth as flat, which is adequate for smaller areas.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w01-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-1','quiz','geodetic','survey-types']),
('A construction survey is also commonly referred to as:', 'multiple_choice', '["A cadastral survey","A layout or stakeout survey","A geodetic survey","A hydrographic survey"]'::jsonb, 'A layout or stakeout survey', 'Construction surveys involve laying out (staking out) planned structures, roads, and utilities in the field so that construction crews know exactly where to build. They are commonly called layout surveys or stakeout surveys.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w01-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-1','quiz','construction','survey-types']),
('GNSS stands for Global Navigation Satellite System.', 'true_false', '["True","False"]'::jsonb, 'True', 'GNSS is the umbrella term for all satellite navigation systems including GPS (US), GLONASS (Russia), Galileo (EU), and BeiDou (China).', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w01-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-1','quiz','gnss']),
('List and describe three different types of surveys discussed in this lesson.', 'short_answer', '[]'::jsonb, 'Boundary, topographic, construction, geodetic, or hydrographic surveys', 'Common types include: boundary/cadastral (property lines), topographic (terrain and features), construction/layout (staking structures), geodetic (large-area with earth curvature), and hydrographic (water boundaries and depths).', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w01-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-1','homework','survey-types']),
('In Texas, what professional license allows a person to practice land surveying independently?', 'short_answer', '[]'::jsonb, 'RPLS (Registered Professional Land Surveyor)', 'In Texas, the RPLS (Registered Professional Land Surveyor) license, issued by TBPELS (Texas Board of Professional Engineers and Land Surveyors), authorizes independent practice of land surveying. The SIT (Surveyor Intern) is the intermediate step.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w01-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-1','homework','licensing','texas']),
('Explain the general steps involved in the "surveying method" from project planning through final deliverables.', 'short_answer', '[]'::jsonb, 'Research, reconnaissance, planning, field measurement, computation/adjustment, mapping/deliverables', 'The surveying method generally includes: (1) research existing records, (2) reconnaissance of the site, (3) plan the survey approach, (4) perform field measurements, (5) compute and adjust observations, (6) prepare maps, plats, or other deliverables.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w01-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-1','homework','surveying-method']),

-- Week 2 Quiz & Homework
('How many significant figures are in the measurement 0.00450?', 'multiple_choice', '["5","4","3","2"]'::jsonb, '3', 'Leading zeros are never significant — they only indicate decimal position. The significant figures are 4, 5, and the trailing 0 (trailing zeros after a decimal point and nonzero digit are significant). So 0.00450 has 3 significant figures.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w02-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-2','quiz','significant-figures']),
('The US Survey foot is defined as exactly:', 'multiple_choice', '["0.3048 meters","1200/3937 meters","0.30480061 meters","12/39.37 meters"]'::jsonb, '1200/3937 meters', 'The US Survey foot = 1200/3937 meters ≈ 0.30480061 m. This differs slightly from the International foot (exactly 0.3048 m). The difference is about 2 ppm, which matters over large distances.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w02-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-2','quiz','units','us-survey-foot']),
('Field notes should be recorded in pencil so that mistakes can be erased and corrected cleanly.', 'true_false', '["True","False"]'::jsonb, 'False', 'Field notes should NEVER be erased. Mistakes should be crossed out with a single line so the original value remains legible, and the correct value written nearby. Erasing destroys the record and is considered unprofessional.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w02-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-2','quiz','field-notes']),
('Convert 45°30''15" to decimal degrees.', 'numeric_input', '[]'::jsonb, '45.5042', 'Decimal degrees = 45 + 30/60 + 15/3600 = 45 + 0.5 + 0.00417 = 45.50417, rounded to 45.5042°.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w02-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-2','quiz','DMS-conversion']),
('When adding angles in DMS format, 47°35''48" + 22°38''25" equals:', 'multiple_choice', '["70°14''13\"","69°74''73\"","70°13''13\"","70°14''73\""]'::jsonb, '70°14''13"', 'Add each column: 48"+25"=73" → 1''13"; 35''+38''+1''=74'' → 1°14''; 47°+22°+1°=70°. Result: 70°14''13".', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w02-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-2','quiz','DMS-arithmetic']),
('Convert 1,250.00 US Survey feet to meters. Show your work.', 'short_answer', '[]'::jsonb, '381.001 meters', '1,250.00 × (1200/3937) = 1,250.00 × 0.30480061 = 381.0008 m ≈ 381.001 m. Using US Survey foot definition.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w02-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-2','homework','unit-conversion']),
('Round 3456.7851 to 4 significant figures and explain your reasoning.', 'short_answer', '[]'::jsonb, '3457', 'The 4th significant digit is 6. The next digit (7) is ≥ 5, so round up: 3456.7851 → 3457 (4 sig figs). When rounding, look at the digit immediately after your last significant figure.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w02-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-2','homework','significant-figures','rounding']),
('What information should be included on the first page of a surveying field book?', 'short_answer', '[]'::jsonb, 'Project name, date, crew members, weather, equipment, location', 'A properly started field book includes: project name/number, date, crew members and their roles, weather conditions, equipment used (with serial numbers), location/description of work area, and a general project sketch or reference.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w02-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-2','homework','field-notes']),

-- Week 3 Quiz & Homework
('Which type of error follows a consistent pattern and can be eliminated by calibration or proper procedures?', 'multiple_choice', '["Random errors","Systematic errors","Blunders","Probable errors"]'::jsonb, 'Systematic errors', 'Systematic errors are consistent in sign and/or magnitude. They can be eliminated through calibration, applying corrections, and proper field procedures. Random errors cannot be eliminated but can be reduced.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w03-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-3','quiz','errors','systematic']),
('Four measurements of a distance are: 200.45, 200.47, 200.43, and 200.46 ft. The most probable value is:', 'numeric_input', '[]'::jsonb, '200.4525', 'MPV = mean = (200.45 + 200.47 + 200.43 + 200.46) / 4 = 801.81 / 4 = 200.4525 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w03-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-3','quiz','statistics','most-probable-value']),
('Two independent errors of ±0.03 ft and ±0.04 ft propagate to a combined error of:', 'numeric_input', '[]'::jsonb, '0.05', 'Error propagation: E = sqrt(0.03² + 0.04²) = sqrt(0.0009 + 0.0016) = sqrt(0.0025) = 0.05 ft. Classic 3-4-5 relationship.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w03-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-3','quiz','error-propagation']),
('A distance of 800.00 ft is measured with an uncertainty of ±0.02 ft. The relative precision is:', 'multiple_choice', '["1:4,000","1:40,000","1:400","1:400,000"]'::jsonb, '1:40,000', 'Relative precision = error/distance = 0.02/800 = 1/40,000 = 1:40,000.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w03-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-3','quiz','precision','relative-precision']),
('Averaging many measurements will eliminate systematic errors.', 'true_false', '["True","False"]'::jsonb, 'False', 'Averaging reduces random errors but does NOT eliminate systematic errors, which affect every measurement consistently. Systematic errors require calibration or correction.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w03-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-3','quiz','errors','averaging']),
('Five measurements of an angle are: 45°12''10", 45°12''14", 45°12''08", 45°12''16", 45°12''12". Calculate the most probable value and the standard deviation.', 'short_answer', '[]'::jsonb, 'MPV = 45°12''12", std dev ≈ 3.2"', 'MPV = mean of seconds: (10+14+8+16+12)/5 = 60/5 = 12". So MPV = 45°12''12". Residuals: -2, +2, -4, +4, 0. Sum v² = 4+4+16+16+0 = 40. σ = sqrt(40/4) = sqrt(10) ≈ 3.16" ≈ 3.2".', 'hard', 'acc00001-0000-0000-0000-000000000001', 'acc01w03-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-3','homework','statistics','standard-deviation']),
('Three independent measurements contribute errors of ±0.02, ±0.03, and ±0.04 ft. What is the total propagated error?', 'numeric_input', '[]'::jsonb, '0.054', 'E = sqrt(0.02² + 0.03² + 0.04²) = sqrt(0.0004 + 0.0009 + 0.0016) = sqrt(0.0029) = 0.0539 ≈ 0.054 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w03-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-3','homework','error-propagation']),
('Explain the difference between precision and accuracy with a surveying example.', 'short_answer', '[]'::jsonb, 'Precision = repeatability; Accuracy = closeness to true value', 'Precision is how closely repeated measurements agree with each other (e.g., five distance measurements all within 0.01 ft). Accuracy is how close measurements are to the true value. A miscalibrated tape could give precise but inaccurate measurements if all readings are consistently offset.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w03-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-3','homework','precision','accuracy']),

-- Week 4 Quiz & Homework
('In differential leveling, the Height of Instrument (HI) is computed as:', 'multiple_choice', '["BM elevation minus backsight","BM elevation plus backsight","BM elevation plus foresight","BM elevation minus foresight"]'::jsonb, 'BM elevation plus backsight', 'HI = Known Elevation + Backsight (BS). The backsight on a known point, added to that point''s elevation, gives the height of the instrument''s line of sight.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w04-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-4','quiz','leveling','HI']),
('A BM has elevation 352.45 ft. BS = 5.67 ft, FS = 3.21 ft. The new point elevation is:', 'numeric_input', '[]'::jsonb, '354.91', 'HI = 352.45 + 5.67 = 358.12 ft. New Elev = 358.12 - 3.21 = 354.91 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w04-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-4','quiz','leveling','computation']),
('The combined curvature and refraction correction formula is C&R = 0.0206F² where F is in:', 'multiple_choice', '["Feet","Miles","Thousands of feet","Meters"]'::jsonb, 'Thousands of feet', 'The formula C&R = 0.0206 × F² uses F in thousands of feet. For example, at 3,000 ft: F = 3.0, C&R = 0.0206 × 9 = 0.185 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w04-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-4','quiz','curvature-refraction']),
('An automatic level maintains a horizontal line of sight using:', 'multiple_choice', '["A spirit bubble vial","A pendulum compensator","Manual adjustment screws","A laser reference"]'::jsonb, 'A pendulum compensator', 'Automatic levels use a pendulum-type compensator that automatically adjusts the line of sight to horizontal after the instrument is approximately leveled. This eliminates the need to precisely center a bubble.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w04-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-4','quiz','level-instruments']),
('In leveling, a foresight reading is subtracted from the HI to determine the elevation of the target point.', 'true_false', '["True","False"]'::jsonb, 'True', 'Elevation = HI - FS. The foresight reading on the rod, subtracted from the Height of Instrument, gives the elevation of the point where the rod is held.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w04-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-4','quiz','leveling','foresight']),
('Given: BM1 elev = 500.00 ft. From Setup 1: BS on BM1 = 8.35, FS on TP1 = 4.12. From Setup 2: BS on TP1 = 6.78, FS on TP2 = 2.95. What is the elevation of TP2?', 'numeric_input', '[]'::jsonb, '508.06', 'Setup 1: HI = 500.00 + 8.35 = 508.35. TP1 elev = 508.35 - 4.12 = 504.23. Setup 2: HI = 504.23 + 6.78 = 511.01. TP2 elev = 511.01 - 2.95 = 508.06 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w04-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-4','homework','leveling','computation']),
('What is the combined curvature and refraction correction for a sight distance of 5,000 ft?', 'numeric_input', '[]'::jsonb, '0.515', 'C&R = 0.0206 × F² = 0.0206 × (5.0)² = 0.0206 × 25 = 0.515 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w04-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-4','homework','curvature-refraction']),
('Explain why keeping backsight and foresight distances equal at each setup eliminates collimation error.', 'short_answer', '[]'::jsonb, 'Equal distances cause equal collimation errors in BS and FS that cancel when computing elevation difference', 'If the line of sight is tilted (collimation error), each reading has an error proportional to sight distance. When BS and FS distances are equal, both readings are affected by the same amount. Since we compute elevation difference as BS - FS, the equal errors cancel out.', 'hard', 'acc00001-0000-0000-0000-000000000001', 'acc01w04-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-4','homework','collimation','leveling']),

-- Week 5 Quiz & Homework
('For a level circuit of 6 miles with k = 0.035 ft/√mi, the allowable misclosure is:', 'numeric_input', '[]'::jsonb, '0.086', 'Allowable = k × √(miles) = 0.035 × √6 = 0.035 × 2.449 = 0.0857 ≈ 0.086 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w05-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-5','quiz','leveling-closure']),
('The two-peg test is used to check for:', 'multiple_choice', '["Curvature and refraction","Collimation error in the level","Rod calibration errors","Temperature effects"]'::jsonb, 'Collimation error in the level', 'The two-peg test determines if the level''s line of sight is truly horizontal by comparing readings from the midpoint (errors cancel) to readings from one end (errors don''t cancel).', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w05-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-5','quiz','two-peg-test']),
('Reciprocal leveling is used primarily when:', 'multiple_choice', '["Speed is needed","Leveling across a wide obstacle like a river","The rod is too short","No benchmark is available"]'::jsonb, 'Leveling across a wide obstacle like a river', 'Reciprocal leveling is used when you cannot place the level midway between two points (e.g., across a river). Readings from both sides are averaged to cancel curvature, refraction, and collimation errors.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w05-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-5','quiz','reciprocal-leveling']),
('Profile leveling is used to determine elevations along a:', 'multiple_choice', '["Property boundary","Route centerline","Building foundation","Geodetic control network"]'::jsonb, 'Route centerline', 'Profile leveling determines ground elevations at intervals along a route (road, pipeline, channel). Results are plotted as a profile graph showing the ground surface along the alignment.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w05-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-5','quiz','profile-leveling']),
('Turning points in differential leveling must be stable and well-defined.', 'true_false', '["True","False"]'::jsonb, 'True', 'Turning points serve as temporary benchmarks. They must be stable (won''t settle or move between readings) and well-defined so the rod is placed in exactly the same spot for both the foresight and the subsequent backsight.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w05-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-5','quiz','turning-points']),
('A level loop starts at BM (elev 100.000) and returns. The computed return elevation is 100.024 ft over 3 miles. Is this acceptable for second-order leveling (k=0.035)?', 'short_answer', '[]'::jsonb, 'Yes, 0.024 ft < allowable 0.061 ft', 'Misclosure = |100.024 - 100.000| = 0.024 ft. Allowable = 0.035 × √3 = 0.035 × 1.732 = 0.061 ft. Since 0.024 < 0.061, the closure is acceptable.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w05-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-5','homework','leveling-closure']),
('In a closed level circuit, the sum of all backsights minus the sum of all foresights should equal:', 'multiple_choice', '["The total distance","Zero","The benchmark elevation","The misclosure"]'::jsonb, 'Zero', 'For a closed level loop returning to the starting BM, the net elevation change is zero, so ΣBS - ΣFS = 0 (theoretically). Any nonzero value is the misclosure.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w05-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-5','homework','leveling','closure-check']),
('Describe the procedure for distributing leveling misclosure proportionally based on distance.', 'short_answer', '[]'::jsonb, 'Correction at each point = -(misclosure × cumulative distance / total distance)', 'The correction at each intermediate point equals: correction = -(misclosure × cumulative distance to that point / total circuit distance). Points farther from the start receive larger corrections. This assumes errors accumulate uniformly with distance.', 'hard', 'acc00001-0000-0000-0000-000000000001', 'acc01w05-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-5','homework','adjustment','leveling']),

-- Week 6 Quiz & Homework
('A steel tape was standardized at 68°F. If used at 95°F to measure 300.00 ft, what is the temperature correction? (Coefficient of expansion = 0.00000645 per °F)', 'numeric_input', '[]'::jsonb, '0.052', 'Ct = 0.00000645 × (95 - 68) × 300 = 0.00000645 × 27 × 300 = 0.0522 ft ≈ 0.052 ft. Tape expanded, so measured distance is too short — add correction.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w06-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-6','quiz','tape-correction','temperature']),
('EDM instruments measure distance by:', 'multiple_choice', '["Counting the number of tape lengths","Timing the travel of electromagnetic waves","Using GPS satellites","Measuring air pressure changes"]'::jsonb, 'Timing the travel of electromagnetic waves', 'EDM instruments emit electromagnetic waves (infrared or laser) and measure the time for the signal to travel to a reflector and back. The distance is computed from the speed of light and the phase shift or travel time.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w06-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-6','quiz','EDM']),
('A slope distance of 500.00 ft measured at a vertical angle of 5°00'' has a horizontal distance of:', 'numeric_input', '[]'::jsonb, '498.10', 'HD = SD × cos(vertical angle) = 500.00 × cos(5°) = 500.00 × 0.99619 = 498.10 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w06-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-6','quiz','slope-distance','horizontal-distance']),
('Stadia is a method of distance measurement that uses:', 'multiple_choice', '["A steel tape only","GPS signals","The stadia hairs in a telescope and a graduated rod","A measuring wheel"]'::jsonb, 'The stadia hairs in a telescope and a graduated rod', 'Stadia uses the upper and lower stadia hairs in the telescope. The rod intercept (difference between upper and lower readings) multiplied by the stadia constant (usually 100) gives the distance. Accuracy is typically 1:300 to 1:500.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w06-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-6','quiz','stadia']),
('A tape correction for sag always makes the measured distance shorter than the true distance.', 'true_false', '["True","False"]'::jsonb, 'True', 'When a tape sags between supports, the catenary curve is longer than the straight-line distance. Therefore the tape reading is too long, and the sag correction is always negative (subtracted from the measured distance).', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w06-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-6','quiz','sag-correction']),
('A 100-ft tape is standardized at 68°F and 12 lbs tension. In the field, temperature is 40°F and tension is 20 lbs. Cross-section area = 0.003 sq in, E = 29,000,000 psi, coefficient = 0.00000645/°F. Compute the total correction per tape length.', 'short_answer', '[]'::jsonb, 'Temp correction = -0.018 ft, Tension correction = +0.009 ft, Total ≈ -0.009 ft', 'Ct = 0.00000645 × (40-68) × 100 = -0.0181 ft. Cp = (20-12) × 100 / (0.003 × 29,000,000) = 800/87,000 = +0.0092 ft. Total = -0.0181 + 0.0092 = -0.009 ft.', 'hard', 'acc00001-0000-0000-0000-000000000001', 'acc01w06-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-6','homework','tape-corrections']),
('Convert a slope distance of 750.00 ft measured at a zenith angle of 86°30'' to horizontal distance.', 'numeric_input', '[]'::jsonb, '748.60', 'Vertical angle = 90° - 86°30'' = 3°30''. HD = 750.00 × cos(3.5°) = 750.00 × 0.99813 = 748.60 ft. Or equivalently: HD = 750 × sin(86°30'') = 748.60 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w06-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-6','homework','slope-to-horizontal']),
('Compare the accuracy of taping, EDM, and stadia methods for measuring distances.', 'short_answer', '[]'::jsonb, 'Stadia: 1:300–1:500; Taping: 1:3,000–1:10,000; EDM: 1:10,000–1:100,000+', 'Stadia is least precise (1:300 to 1:500), suitable for topography. Taping with corrections achieves 1:3,000 to 1:10,000. EDM is most precise at 1:10,000 to 1:100,000 or better, and is the standard for modern surveys.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w06-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-6','homework','distance-methods-comparison']),

-- Week 7 Quiz & Homework
('An azimuth of 225° corresponds to a bearing of:', 'multiple_choice', '["N 45° E","S 45° W","S 45° E","N 45° W"]'::jsonb, 'S 45° W', 'Azimuths 180°-270° are in the SW quadrant. Bearing = S (azimuth - 180°) W = S (225-180)° W = S 45° W.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w07-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-7','quiz','azimuth-to-bearing']),
('A bearing of N 60°30'' E corresponds to an azimuth of:', 'numeric_input', '[]'::jsonb, '60.5', 'N 60°30'' E is in the NE quadrant. Azimuth = bearing angle = 60°30'' = 60.5°.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w07-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-7','quiz','bearing-to-azimuth']),
('Magnetic declination is the angular difference between:', 'multiple_choice', '["True north and grid north","True north and magnetic north","Grid north and magnetic north","Map north and geodetic north"]'::jsonb, 'True north and magnetic north', 'Magnetic declination (or variation) is the angle between true (geographic) north and magnetic north at a given location. It varies with location and changes over time.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w07-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-7','quiz','declination']),
('Subtract: 180°00''00" - 45°38''25" = ?', 'multiple_choice', '["134°21''35\"","135°38''25\"","134°22''35\"","135°21''35\""]'::jsonb, '134°21''35"', '180°00''00" - 45°38''25": Borrow: 179°59''60" - 45°38''25" = 134°21''35".', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w07-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-7','quiz','DMS-arithmetic']),
('A deflection angle is measured from the extension of the back line.', 'true_false', '["True","False"]'::jsonb, 'True', 'A deflection angle is measured from the prolongation (extension) of the preceding line to the next line. It is designated as right (R) or left (L) and cannot exceed 180°.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w07-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-7','quiz','deflection-angles']),
('Convert the following bearings to azimuths: (a) N 35°20'' E, (b) S 72°45'' E, (c) S 15°10'' W, (d) N 80°00'' W.', 'short_answer', '[]'::jsonb, '(a) 35°20'', (b) 107°15'', (c) 195°10'', (d) 280°00''', '(a) NE quadrant: Az = 35°20''. (b) SE: Az = 180° - 72°45'' = 107°15''. (c) SW: Az = 180° + 15°10'' = 195°10''. (d) NW: Az = 360° - 80°00'' = 280°00''.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w07-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-7','homework','bearing-azimuth-conversion']),
('At a location the magnetic declination is 8°30'' East. A compass bearing reads N 45°30'' E. What is the true bearing?', 'short_answer', '[]'::jsonb, 'N 54°00'' E', 'With east declination, magnetic north is east of true north. True bearing = magnetic bearing + declination (for NE bearings) = 45°30'' + 8°30'' = N 54°00'' E.', 'hard', 'acc00001-0000-0000-0000-000000000001', 'acc01w07-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-7','homework','declination','correction']),
('A five-sided closed traverse has interior angles measured as: 98°15'', 110°30'', 122°45'', 88°10'', and 120°25''. What is the angular misclosure?', 'short_answer', '[]'::jsonb, '5'' misclosure', 'Sum of interior angles for 5-sided polygon = (5-2) × 180° = 540°00''00". Measured sum = 98°15'' + 110°30'' + 122°45'' + 88°10'' + 120°25'' = 540°05''. Misclosure = 540°05'' - 540°00'' = +5''.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w07-0000-0000-0000-000000000001', 'ACC-1301', ARRAY['acc-srvy-1301','week-7','homework','angular-closure','traverse']);
...
INSERT INTO question_bank (question_text, question_type, options, correct_answer, explanation, difficulty, module_id, lesson_id, exam_category, tags) VALUES
('Which of the following is NOT a type of survey?', 'multiple_choice', '["Boundary survey","Topographic survey","Arithmetic survey","Construction survey"]'::jsonb, 'Arithmetic survey', 'Arithmetic survey is not a recognized survey type. Common types include boundary, topographic, construction, geodetic, hydrographic, route, and ALTA/NSPS surveys.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','survey-types']),
('The most probable value of a set of equally weighted measurements is the:', 'multiple_choice', '["Median","Mode","Arithmetic mean","Largest value"]'::jsonb, 'Arithmetic mean', 'For equally weighted measurements with only random errors, the arithmetic mean is the most probable value (MPV). It minimizes the sum of squared residuals.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','statistics']),
('BM elevation = 245.67 ft, BS = 7.89 ft, FS = 5.12 ft. Point elevation = ?', 'numeric_input', '[]'::jsonb, '248.44', 'HI = 245.67 + 7.89 = 253.56. Elev = 253.56 - 5.12 = 248.44 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','leveling']),
('A slope distance of 400.00 ft at zenith angle 88° has a horizontal distance of:', 'numeric_input', '[]'::jsonb, '399.76', 'Vert angle = 90° - 88° = 2°. HD = 400 × cos(2°) = 400 × 0.99939 = 399.76 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','distance']),
('An azimuth of 315°00'' corresponds to bearing:', 'multiple_choice', '["N 45° E","N 45° W","S 45° E","S 45° W"]'::jsonb, 'N 45° W', 'Azimuths 270°-360° are in the NW quadrant. Bearing = N (360° - 315°) W = N 45° W.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','bearings-azimuths']),
('Systematic errors in surveying can be detected by averaging multiple measurements.', 'true_false', '["True","False"]'::jsonb, 'False', 'Averaging reduces random errors but does NOT detect or eliminate systematic errors. Systematic errors must be found through calibration, different measurement methods, or applying known corrections.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','errors']),
('How many significant figures are in 10,500?', 'multiple_choice', '["3","4","5","Ambiguous without more context"]'::jsonb, 'Ambiguous without more context', 'The number 10,500 is ambiguous: it could have 3, 4, or 5 significant figures depending on whether the trailing zeros are significant. Using scientific notation resolves this: 1.05 × 10⁴ (3 sig figs) vs 1.050 × 10⁴ (4 sig figs).', 'hard', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','significant-figures']),
('What is the tape temperature correction for measuring 250.00 ft at 32°F if the tape is standardized at 68°F? (coeff = 0.00000645/°F)', 'numeric_input', '[]'::jsonb, '-0.058', 'Ct = 0.00000645 × (32-68) × 250 = 0.00000645 × (-36) × 250 = -0.0581 ≈ -0.058 ft. Negative because tape contracted in cold.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','tape-correction']),
('The formula for relative precision is:', 'multiple_choice', '["Error × distance","Error / distance","Distance / error","Error + distance"]'::jsonb, 'Error / distance', 'Relative precision = linear error of closure / total distance. Often expressed as a ratio like 1:10,000.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','precision']),
('The International foot equals exactly 0.3048 meters.', 'true_false', '["True","False"]'::jsonb, 'True', 'The International foot is defined as exactly 0.3048 meters (25.4 mm per inch). This differs slightly from the US Survey foot (1200/3937 m).', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','units']),
('C&R correction at 2,500 ft is:', 'numeric_input', '[]'::jsonb, '0.129', 'C&R = 0.0206 × (2.5)² = 0.0206 × 6.25 = 0.12875 ≈ 0.129 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','curvature-refraction']),
('A four-sided closed traverse should have interior angles summing to:', 'multiple_choice', '["180°","360°","540°","720°"]'::jsonb, '360°', 'Sum of interior angles = (n-2) × 180° = (4-2) × 180° = 360°.', 'easy', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','traverse','angles']),
('Three propagated errors of ±0.01, ±0.02, and ±0.03 ft combine to:', 'numeric_input', '[]'::jsonb, '0.037', 'E = sqrt(0.01² + 0.02² + 0.03²) = sqrt(0.0001+0.0004+0.0009) = sqrt(0.0014) = 0.0374 ≈ 0.037 ft.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','error-propagation']),
('Convert S 28°45'' W to an azimuth.', 'numeric_input', '[]'::jsonb, '208.75', 'SW quadrant: Az = 180° + 28°45'' = 208°45'' = 208.75°.', 'medium', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','bearing-to-azimuth']),
('What leveling order uses k = 0.050 ft/√mi for allowable closure?', 'multiple_choice', '["First order","Second order","Third order","Fourth order"]'::jsonb, 'Third order', 'k values: first-order ≈ 0.017, second-order ≈ 0.035, third-order ≈ 0.050. Third-order leveling allows 0.050 × √(miles).', 'hard', 'acc00001-0000-0000-0000-000000000001', 'acc01w08-0000-0000-0000-000000000001', 'ACC-1301-MIDTERM', ARRAY['acc-srvy-1301','midterm','leveling-standards']);
