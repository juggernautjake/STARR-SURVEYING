...
WITH expected_tables(t, source_seed_hint) AS (
  VALUES
    ...
    ('messages',                  'pre-220'),
    ('discussions',               'pre-220'),
    ('discussion_messages',       'pre-220'),
    ('message_contacts',          'pre-220'),
    ('notes',                     'pre-220'),
    ...
    ('assignments',               'pre-220'),
    ('leads',                     'pre-220'),
    ('mileage_entries',           'pre-220'),
    ('schedule_events',           'pre-220'),
    ('learning_progress',         'pre-220'),
    ...
    ('rewards_balance',           'pre-220'),
    ('rewards_history',           'pre-220'),
    -- Starr Field receipts module
    ('receipts',                  'seed 220'),
    ('receipt_line_items',        'seed 220'),
    ('receipt_attachments',       'seed 229+'),
