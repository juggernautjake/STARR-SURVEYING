-- ============================================================================
-- 060_articles.sql
-- Knowledge base articles: Bearings & Azimuths, Boundary Surveys, GNSS/GPS,
-- and the Survey Chain history article. Includes article quiz questions,
-- flashcards, and required-reading links.
-- Depends on: 010_curriculum.sql (for module_id refs), 020_acc.sql (for lesson refs)
-- ============================================================================

BEGIN;

-- ============================================================================
-- SECTION 1: KNOWLEDGE BASE ARTICLES (Curriculum-linked)
-- Three short articles linked to curriculum modules via module_id + xp_reward
-- ============================================================================
...
-- ============================================================================
-- SECTION 2: SURVEY CHAIN ARTICLE (full-length history article)
-- Article UUID: a1100001-0000-0000-0000-000000000001
-- Linked to SRVY 1341 (module) / Lesson 2 (lesson)
-- ============================================================================
...
-- ============================================================================
-- SECTION 3: REQUIRED-READING LINK (Survey Chain → SRVY 1341 Lesson 2)
-- ============================================================================
...
-- ============================================================================
-- SECTION 4: ARTICLE QUIZ QUESTIONS
-- Questions linked to KB articles via article_id for earning article XP.
-- Uses INSERT...SELECT with CROSS JOIN on slug to resolve article_id at runtime.
-- ============================================================================

-- Clean existing article quiz questions before re-inserting (idempotency)
DELETE FROM question_bank WHERE exam_category = 'article-quiz'
  AND article_id IN (SELECT id FROM kb_articles WHERE slug IN ('bearings-and-azimuths', 'what-is-a-boundary-survey', 'gnss-gps-for-surveyors'));
...
-- ============================================================================
-- SECTION 5: FLASHCARDS (10 cards for the Survey Chain article)
-- Uses DELETE + INSERT for safe re-run.
-- ============================================================================
