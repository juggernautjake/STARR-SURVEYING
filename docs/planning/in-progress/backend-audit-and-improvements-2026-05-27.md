...
- [ ] **Per-page formatting/menu/font sweep** — screenshot each registered page via the harness, inspect, fix issues. Registered: dashboard, jobs, leads, notes, receipts, payroll, settings, mileage, assignments, reports, equipment, invites (more to add). Settings ✓ clean.
