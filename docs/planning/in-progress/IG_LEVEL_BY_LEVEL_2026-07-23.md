...
- [ ] **IG-2 — interactive `igPlanLevelUp`** — outstanding choices to resolve (trait / feat-by-category /
  ability-boosts ×2 / subclass-power / specialization / skill / capstone), mirroring `pf2PlanLevelUp`.
