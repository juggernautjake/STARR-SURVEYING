...
| **P9** | CSS (`fs-module__practice`, `fs-module__flashcards`), tests, verify end-to-end | PARTIAL — panel CSS already exists in `app/admin/styles/AdminLearn.css` (`fs-practice__*`, `fs-flash__*` all defined; verified 2026-07-05). Remaining: automated tests + a manual end-to-end pass. |
