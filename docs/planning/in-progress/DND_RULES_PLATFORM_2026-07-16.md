...
- [~] **6a — D&D 5e 2014**: all 12 classes + Artificer, L1–20. The 2014/2024 differences are the
      ...
      **Started 2026-07-16 — Barbarian ✅ + Fighter ✅ + Rogue ✅ + Monk ✅ SHIPPED** (`lib/dnd/classes/dnd5e-2014/`).
      Monk L1–20 + all three PHB traditions (Open Hand, Shadow, Four Elements); the resource is "Ki"
      (2024 renamed it Focus), equal to Monk level from level 2.
      ...
      **Remaining 6a:** the other 8 classes + Artificer.
