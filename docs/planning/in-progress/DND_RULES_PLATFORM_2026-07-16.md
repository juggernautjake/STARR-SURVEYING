...
- [~] **6a — D&D 5e 2014**: all 12 classes + Artificer, L1–20. The 2014/2024 differences are the
      ...
      **Started 2026-07-16 — 7/12 SHIPPED: Barbarian ✅ Fighter ✅ Rogue ✅ Monk ✅ Ranger ✅ Paladin ✅
      Sorcerer ✅** (`lib/dnd/classes/dnd5e-2014/`). Sorcerer L1–20 (first **full caster**: spells known,
      cantrips, d6) — Sorcerous Origin at **level 1** (the Sorcerer quirk), Font of Magic / Sorcery
      Points (== level from 2), Metamagic at 3/10/17, and both PHB origins (Draconic Bloodline, Wild
      Magic). Paladin L1–20 (half-caster, CHA, spells PREPARED) with Divine
      ...
      **Remaining 6a:** the other 5 classes + Artificer (Bard, Cleric, Druid, Warlock, Wizard).
