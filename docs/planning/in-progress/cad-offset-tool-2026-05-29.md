...
#### Slice 1 — OffsetPanel component (distance + unit + commit)
...
- **Files:** `app/admin/cad/components/OffsetPanel.tsx`, `lib/cad/operations/apply-offset-from-panel.ts`, `__tests__/cad/operations/apply-offset-from-panel.test.ts`
...
#### Slice 2 — Right-click "Create offset" → opens the panel
...
- **Files:** `app/admin/cad/components/FeatureContextMenu.tsx`, `app/admin/cad/components/CanvasViewport.tsx`
