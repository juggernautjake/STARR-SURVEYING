...
describe('Phase 19 — Spec Document (docs/planning/completed/STARR_RECON/PHASE_19_LIDAR_CROSSCOUNTY.md)', () => {
  const SPEC_PATH = path.resolve(__dirname, '../../docs/planning/completed/STARR_RECON/PHASE_19_LIDAR_CROSSCOUNTY.md');
