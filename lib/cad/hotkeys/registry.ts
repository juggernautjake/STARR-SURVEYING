...
export const DEFAULT_ACTIONS: BindableAction[] = [
  ...
  { id: 'tool.simplify',     category: 'TOOLS',      label: 'Simplify polyline',    description: 'Drop redundant vertices from a POLYLINE / POLYGON using a 0.5 ft tolerance (Ramer-Douglas-Peucker algorithm).', defaultKey: '', isChord: false, context: 'CANVAS' },
