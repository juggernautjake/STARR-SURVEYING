  ...
  return (
    <ModalShell title="Clock in" onClose={onClose}>
      <label style={fieldStyle}>
        ...
        <input type="text" value={jobId} placeholder="Job number or id" onChange={(e) => setJobId(e.target.value)} style={inputStyle} />
      </label>
      <fieldset style={{ border: '1px solid var(--theme-border)', borderRadius: 6, padding: 'var(--hub-spc-3, 12px)' }}>
        <legend style={labelStyle}>Activity tags</legend>
  ...
  return (
    <ModalShell title="Wrap your day" onClose={onClose}>
      ...
      <label style={fieldStyle}>
        ...
        <textarea value={notes} rows={3} onChange={(e) => setNotes(e.target.value)} style={{ ...inputStyle, height: 72, resize: 'vertical' }} />
      </label>
