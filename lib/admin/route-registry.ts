...
export const ADMIN_ROUTES: AdminRoute[] = [
  ...
  { href: '/admin/payouts/withdrawals',   label: 'Withdrawal Requests', workspace: 'money', section: 'Money out', iconName: 'HandCoins',    description: 'Money employees have asked to take out of the balance they have earned — approve it, decline it with a reason, or record that it has actually been sent.', roles: ['admin'], internalOnly: true, keywords: ['withdraw', 'withdrawal', 'cash out', 'balance', 'request money', 'transfer'] },
