...
export const ADMIN_ROUTES: AdminRoute[] = [
  ...
  { href: '/admin/files',           label: 'Files',           workspace: 'office', iconName: 'FolderOpen',     description: 'Company file explorer — browse, upload, organize, and share files with folder permissions.', roles: ['admin', 'developer', 'field_crew', 'drawer', 'researcher', 'equipment_manager', 'tech_support'], internalOnly: true, keywords: ['files', 'explorer', 'documents', 'folders', 'storage'] },
