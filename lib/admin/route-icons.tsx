...
import {
  ...
  FolderOpen, FolderKanban, FolderPlus, GanttChart, Gauge, Globe, GraduationCap, HandCoins, HardHat, HelpCircle, History, Home, Image,
  Inbox, KeyRound, Landmark, Phone,
  Layers, LayoutDashboard, Library, LifeBuoy, Lightbulb, ListChecks, Lock, MailCheck, MailPlus, Map, MapPin,
  Megaphone, MessageSquare, MessageSquarePlus, MessagesSquare, Microscope, Monitor, Notebook, NotebookPen,
  Package, PackageOpen, PaintBucket, Palette, Palmtree, Pencil, PenTool, PieChart, Play, Plus, Receipt, ReceiptText,
  Rocket, Route, Satellite, Scale, ScrollText, Search, Settings, Settings2,
  ShieldBan, ShieldCheck, ShieldPlus, ShieldQuestion, Smartphone, Sparkles, SquarePen, StickyNote, Tags, Timer, Trash2, TrendingUp,
