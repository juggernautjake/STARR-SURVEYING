...
// worth hearing on a phone line. The order is the order they are offered — the warm, unhurried
// American women first, because that is the brief for a surveying office; the rest are there so the
// owner can hear the difference rather than take the shortlist on trust.
//
...
export const AGENT_VOICES: readonly AgentVoice[] = [
  { id: 'EXAVITQu4vr4xnSDxMaL', name: 'Sarah', blurb: 'Mature, reassuring, confident. The one the agent uses today.', group: 'Women, American', recommended: true },
  ...
  { id: 'hA4zGnmTwX2NQiTRMt7o', name: 'Riley', blurb: 'Younger and engaging. Friendly, slightly informal.', group: 'Women, American' },
