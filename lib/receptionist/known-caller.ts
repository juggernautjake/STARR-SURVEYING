...
export function knownCallerLine(k: KnownCaller | null): string | null {
  ...
  return [
    ...
    `HOW TO USE IT: do not greet them by name, do not say the name on file, and do not mention any of these jobs first. Ask "have you called us before?" and "who am I speaking with?" like you would anyone. If the name they give matches the file, say you have them on file and then ASK WHICH IT IS: "are you calling about the property you spoke to us about before, or is this a new request?" Name the property only after they have said it is the same one. If they say it is new, take it from scratch — new property, new details, nothing carried over. If the name does not match — phones get shared and handed on — treat them as a brand new caller and take everything fresh.`,
