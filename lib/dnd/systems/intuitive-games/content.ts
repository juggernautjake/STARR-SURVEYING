...
export const IG_POWERS: NamedEntry[] = [
  // Every roster spell's effect is the VERBATIM Description from intuitivegames.net/spell-list
  // (scraped 2026-07-17, all toggles opened) — nothing paraphrased or invented (Ground Rule 2). ──
  { name: "Dispel Magic", category: "Abjuration", effect: "As a Reaction when another character uses Divine Blessing, Aura Mastery, casts a spell, or uses a similar ability within 30 feet of your character, you may make a Spellcraft check to counter their ability. Unless your check exceeds the result of the roll for their original check, their action continues without interruption. If your result is greater than theirs, they lose their action with no effect." },
  { name: "Protection From Elements", category: "Abjuration", effect: "Grant elemental resistance against one chosen element equal to your intelligence modifier for yourself or another creature. This effect lasts for a number of minutes equal to your spellcraft modifier. Range: Any touched creature. Special: If you have the Aura Mastery feat, you may affect the same number of creatures with this ability that you can with Aura Mastery and may affect them at the same range." },
  { name: "Shield Ally", category: "Abjuration", effect: "As a reaction, you may grant an adjacent ally a +2 bonus on any saving throw as soon as the saving throw is called for. The bonus to that saving throw lasts for one round. Range: Any ally within 30 feet." },
  { name: "Conjure Wall", category: "Conjuration", effect: "As a two-action activity, you can create a wall made out of one of the materials listed below. The wall stretches over a number of hexes equal to your level. This wall is 10 feet tall, but sections of can be stacked on top of themselves to become taller. It lasts for a number of rounds equal to your Intelligence modifier. You know how to make one wall for every two levels that you have acquired. These walls are chosen when you gain this ability and when your level increases to the appropriate number to learn a new wall. This spell has a range of a number of hexes equal to your Spellcraft modifier." },
  { name: "Create Shelter", category: "Conjuration", effect: "As a ten-action activity, you can create a shelter made out of materials natural in your current environment. The shelter stretches over a number of hexes equal to your level + your Intelligence modifier and is 10 feet tall. Add one feature when you create the structure. You may add another feature to the shelter for every 2 levels you have. See the list below. This spell has a range of a number of hexes equal to your Spellcraft modifier. This shelter disappears after a number of hours equal to your Spellcraft skill, but you may reset the duration by casting the spell again before it ends." },
  { name: "Gate", category: "Conjuration", effect: "As a three-action activity, you may open a gate into the Echo. In the Echo, distance is divided by 10. You must spend an additional three-action activity to reopen the gate from the Echo to re-enter your home world. The gate is 10 feet tall and 10 feet wide. The gate disappears after 1 minute has passed, or you can dismiss it as an action." },
  ...
  { name: "Portal", category: "Conjuration", effect: "As an action, you may relocate yourself to another hex within sight. This hex can be no farther than 5 feet per level from your original location. You can only use this ability once per round." },
  { name: "Summon Material", category: "Conjuration", effect: "Summon one of the materials listed below. It covers a number of contiguous hexes equal to your level + your intelligence modifier. The materials dissipate after a number of rounds equal to your Spellcraft bonus." },
  { name: "Teleportation", category: "Conjuration", effect: "As a three-action activity, you may teleport to a location you have been to before. This location must be within a number of miles of your current location equal to your level + your intelligence modifier." },
  { name: "Unseen Servant", category: "Conjuration", effect: "As a three-action activity, you conjure an invisible force that can perform basic tasks for you. The force begins anywhere within 30 feet of you. You may only have one Unseen Servant at any given time. Duration: a number of minutes equal to your level plus your intelligence modifier. The servant can manifest in any one of the ways outlined below. Servants may take actions in combat but need to be directed to do so using an action." },
  ...
  { name: "Detect Magic", category: "Divination", effect: "As an action, you begin to discern any magical or supernatural abilities currently in effect as well as any creatures who have connections to the arcane or the divine which grant them supernatural powers. Duration: 1 minute per level. Range: a number of hexes equal to your Spellcraft modifier." },
  ...
  { name: "Foresight", category: "Divination", effect: "By spending time in uninterrupted meditation, you may look through the Void to learn more about something. Pick one of the options below each time you do this." },
  { name: "Scrying", category: "Divination", effect: "Scrying You attempt to locate a creature or object. When locating a creature, you make a Spellcraft check, opposed by the creature’s will save to avoid being scried upon. If you are not familiar with the creature they receive advantage on their save. Familiarity with a creature is determined by knowing at least two facts from the list below. Name Physical description Identifying characteristicApproximate location (within 1 mile) This spell has a range of a number of miles equal to your Spellcraft modifier. Critical Success You identify how far away the creature is from you and know which direction to travel to get to the creature for a number of hours equal to your intelligence modifier. You see a vision of the creature and 5 feet of their surroundings for up to one minute after the spell succeeds. Success You identify how far away the creature is from you and know which direction to travel to get to the creature for a number of hours equal to your intelligence modifier. Partial Success The spell fails, but you know the approximate distance of the creature from your location. Failure The spell fails. Critical Failure The spell fails and the creature knows someone attempted to scry on them." },
  ...
  { name: "Command", category: "Enchantment", effect: "As a two-action activity, you make a Spellcraft check opposed by the creature’s will save. If the creature fails, they take no actions except for a single action that you direct them to take. Range: 30 feet. Special: If you have the Aura Mastery feat, you may affect the same number of creatures with this ability that you can with Aura Mastery and may affect them at the same range. Critical Success This effect lasts for a number of rounds equal to your Intelligence modifier. Success The effect succeeds as written. Partial Success The spell fails, but the creature loses an action on its next turn. Failure The spell fails. Critical Failure The spell fails and you lose your reaction this turn." },
  { name: "Enchant Creature", category: "Enchantment", effect: "As a two-action activity, you make a Spellcraft check opposed by the creature’s will save. If the creature fails, they become enthralled with you for one round. You may continue to enthrall them with a single action on each turn following, so long as they are not put in imminent danger. An enthralled creature follows you around and will perform a single action of your choice each round. If they are put in a dangerous situation, they receive another will save for each round that they remain in that situation. Range: 30 feet. Duration: A number of rounds equal to your Intelligence modifier. Special: If you have the Aura Mastery feat, you may affect the same number of creatures with this ability that you can with Aura Mastery and may affect them at the same range. Critical Success This effect lasts for a number of rounds equal to double your Intelligence modifier. Success The effect succeeds as written. Partial Success The spell fails, but the creature loses an action on its next turn. Failure The spell fails. Critical Failure The spell fails and you lose your reaction this turn." },
  ...
  { name: "Subtle Manipulation", category: "Enchantment", effect: "You may make a Spellcraft check instead of your choice of a Bluff, Diplomacy, Intimidate, or Perform check. You gain a +2 bonus on the check if you are trained in the skill that you are imitating." },
  ...
  { name: "Intense Blast", category: "Evocation", effect: "As a two-action activity, use your Elemental Blast ability. If you hit, deal an additional 1d6 points of damage and ignore any elemental resistances the target might possess." },
  ...
  { name: "Telekinesis", category: "Evocation", effect: "As a two-action activity, you may force a target creature or object in a certain direction." },
  ...
  { name: "Wind Blast", category: "Evocation", effect: "You gain a proficient attack that deals bludgeoning damage equal to your Elemental Blast. (Normally your level + your intelligence modifier.)In addition, the spell extinguishes open flames and disperses fog and mist within a radius centered on you. The radius size is based on the range of your Elemental Blast. (Normally 30 feet)" },
  { name: "Create Image", category: "Illusion", effect: "As a two-action activity, you create an image covering a number of hexes equal to your Spellcraft modifier. This image is 5 feet tall, but you may stack the hexes on top of each other. You must spend a single action each round maintaining the illusion. Any creature that comes within the range of one of their senses other than sight receives a will save to disbelieve the illusion. This is opposed by your Spellcraft check. Range: A number of hexes equal to your Spellcraft skill." },
  { name: "Darkness", category: "Illusion", effect: "Decrease the illumination levels by two steps in a circle with a radius equal to your Intelligence modifier. Duration: A number of rounds equal to your Spellcraft skill. Range: A number of hexes equal to your Spellcraft skill." },
  ...
  { name: "Invisibility", category: "Illusion", effect: "You cause a creature or object to become invisible with a touch. Duration: A number of rounds equal to your Spellcraft modifier. The invisibility falls away if the subject attacks another creature." },
  { name: "Light", category: "Illusion", effect: "Increase the illumination levels by two steps in a circle with a radius equal to your Intelligence modifier. Duration: A number of rounds equal to your Spellcraft skill. Range: A number of hexes equal to your Spellcraft skill." },
  { name: "Mimic Sound", category: "Illusion", effect: "As as a two-action activity, you create a sound within 20 feet of your character. The range of this spell increases by 20 feet at every level. You may spend a single action each round maintaining the sound or adjusting it. Any creature that hears the sound makes a Perception check. This is opposed by your Spellcraft check made whenever you cast the spell. Critical Success The creature believes the sound and other senses play tricks on them, encouraging them to believe that the sound is real. Success The creature believes that the sound is real. Partial Success The creature believes that the sound is real, but that it may be echoing or distorted somehow. Failure The creature can tell that the sound is not authentic. Critical Failure The creature can tell that the sound is not authentic and can identify you or the hex that you are in (if the creature cannot see you) as the true source of the deception." },
  { name: "Mirror Image", category: "Illusion", effect: "As a two-action activity, create 1d4 mirror images of yourself. These images cause your attackers to not be able to locate you and they last for one minute. Whenever you are subject to an attack, your attacker must attempt to attack you as normal. If their attack succeeds, and even if it critically succeeds, the attacker must roll 1d2, 1d3, 1d4, or 1d5 in order to hit you based on how many mirror images you have remaining. In order to hit you, the attacker must roll a 1. Normally a player will use a d6 in the case of 2 apparitions and would divide the die result between the three targets." },
  { name: "Adaptation", category: "Transmutation", effect: "You or another creature gains an adaptation to a natural climate. Choose one from the list below. The effects last for a number of hours equal to your intelligence modifier. Range: Any touched creature. Special: If you have the Aura Mastery feat, you may affect the same number of creatures with this ability that you can with Aura Mastery and may affect them at the same range." },
  ...
  { name: "Natural Attacks", category: "Transmutation", effect: "As a two-action activity, grant yourself or another touched creature natural attacks. These attacks deal 1d6 points of damage and can come in the form of growing a claw, a bite, or some other attack that makes sense based on your/their physiology. Special: If you have the Aura Mastery feat, you may affect the same number of creatures with this ability that you can with Aura Mastery and may affect them at the same range." },
  { name: "New Movement", category: "Transmutation", effect: "Cause yourself or another creature to grow wings, webbed feet, or some other appendage that grants a new form of movement. Choose a form from the list below. If a creature already has the form of movement chosen, they increase it by the amount listed. Range: Any touched creature. Special: If you have the Aura Mastery feat, you may affect the same number of creatures with this ability that you can with Aura Mastery and may affect them at the same range." },
  ...
  // ── Not on the current site roster — kept (not deleted) pending owner/Brendan reconciliation
  //    (renamed vs dropped); surfaced by igPowersNotInRoster(). Text is the prior sheet-template text. ──
...
export const IG_CLASS_DETAILS: IGClassDetail[] = [
  ...
  { name: 'Magician', classification: 'subclass of Wizard', primaryAbility: 'Intelligence', grantedStance: 'Shifting', defensivePower: 'Misdirection', startingPower: 'Elemental Blast (inherited from Wizard)', powers: ['Arcane Spell', 'Bane', 'Deviant Magic', 'Magic Trick', 'Mirror Image', 'Personal Style'], specializations: ['Illusionist (a failed will save vs your illusion deals fear-based nonlethal damage)', 'Magical Savant (learn the Advanced ability for a spell you know)'], note: 'Manifestation: Elemental Carnage (blast damage becomes 1d6 per Intelligence modifier point).' },
  { name: 'Shaman', classification: 'subclass of Wizard', primaryAbility: 'Intelligence', grantedStance: 'Defensive', defensivePower: 'Life Connection', startingPower: 'Elemental Blast (inherited from Wizard)', powers: ['Arcane Spell', 'Boon', 'Ethereal Might', 'Ghost-whisperer', 'Magical Healing', 'Magic Trick'], specializations: ['Specter (elemental blast may instead deal force damage)', 'Magical Savant (learn the Advanced ability for a spell you know)'], note: 'Manifestation: Elemental Carnage (blast damage becomes 1d6 per Intelligence modifier point).' },
...
// ── Class power effect text (from intuitivegames.net/classes, Playwright-scraped 2026-07-18). The
//    `powers`/`specializations` arrays above hold NAMES; this maps each name → its verbatim effect so the
//    builder's class preview and the sheet's feature bodies can show what a power DOES (not just its name).
//    Verbatim from the site (Ground Rule 2 — never invented). The Conduit material blurbs (Fine Particles,
//    Fluids, Gems, Metals, Oozes, Organic Matter, Stone) ride along here since the site lists them as
//    redistribution "powers"; first-seen phrasing wins where a name recurs across subclasses. ──────────────
export const IG_CLASS_POWER_EFFECTS: Record<string, string> = {
  "Additional Creature": "You gain an additional Companion. This companion is built using the same rules as your original companion but does not need to be the same type of creature.",
  "Additional Trait": "Gain an additional trait of your choice. As with most powers, you may only select this power one time.",
  "Advanced Combat Skill": "As an action, you may make a combat skill check along with a melee attack. Roll both and resolve the attack first. You must be trained in the combat skill used.",
  "Advanced Material": "Choose one material that you can redistribute. When redistributing this material, you gain the ability to control the matter more effectively. You may redistribute a number of pounds of this material equal to your level + your Wisdom modifier.",
  "Alter Self": "As an action, you can change your appearance to have different features, even to the point of appearing to have a different ancestry. This does not change your size category. This effect lasts for a number of minutes equal to your Nature skill. You take 1 point of nonlethal damage when the effect wears off. The Aura Mastery feat allows you to use this ability on the same number of willing creatures within the same range that your Aura Mastery feat allows, including yourself.",
  "Arcane Spell": "Gain access to a single arcane spell of your choice from the spell list. Arcane spells always take two actions to cast unless the spell specifically gives an action for its use. Evocation spells enhance the Elemental Blast power instead of granting a new spell. You may take this power multiple times. Each time, you learn a new spell.",
  "Aspect": "Select one aspect for your companion creature. A creature can only have one aspect; once it is chosen, it cannot be changed.",
  "Bane": "You gain the Divine Blessing feat, but you must select your two abilities from one of the curses listed below. Use your Spellcraft skill and your intelligence modifier instead of your Religion skill and your Wisdom modifier for this ability. Ancestors, Light, Darkness, Void, Peace, Entropy.",
  "Boon": "You gain the Divine Blessing feat, but you must select your two abilities from one of the blessings listed below. Use your Spellcraft skill and your intelligence modifier instead of your Religion skill and your Wisdom modifier for this ability. Strength, Dexterity, Constitution, Intelligence, Wisdom, Charisma.",
  "Chakra Master": "Gain a power from the list below. Dash: Move at your full movement speed when taking a step action. Seismic sense: Gain tremorsense out to a range of 20 feet. Precise footwork: Gain an initiative bonus equal to your level. Healing: Copy the Shaman healing ability, using your level instead of your Intelligence modifier. If you use this with the Aura Mastery feat, you must make a Religion check instead of a Spellcraft check.",
  "Challenge": "Pick one creature within sight as an action. Until you or that creature is dead, unconscious, or 1-minute passes, you gain a +2 on damage rolls against them.",
  "Charm": "You gain the ability to hypnotize another creature of lesser or comparable Intelligence. If a creature has an Intelligence modifier that is no more than +1 higher than yours, you may use the ability below. Make a Diplomacy or Arcane check opposed by your target's will save. If you succeed, the target gains the helpful condition towards you for a number of minutes equal to your Charisma modifier + your level.",
  "Chi Strike": "As a three-action activity, you may make an attack that is amplified using one of the abilities below. Attack any creature you can see within 30 feet with a melee attack. The target of your attack has disadvantage on their reflex save to avoid the attack. Curse a target hit by your attack by forcing them to make their next two rolls after being hit by your attack at disadvantage.",
  "Combat Feat": "You may select a combat feat of your choice. The normal rules and prerequisites for combat feats still apply. As with most powers, you may only select this power one time.",
  "Combat Skill Proficiency": "Gain proficiency in a single combat skill of your choice. This power can be selected more than once. Each time you select it, you gain proficiency in an additional combat skill.",
  "Combat-Trained": "Your Companion gains a Combat Feat of your choice.",
  "Conjurer": "You learn how to cast a single conjuration spell of your choice. When you learn the spell, you choose which skill and relevant ability score to use from the list below: Arcane, Religion, Spellcraft, Nature. If a spell depends on a Wizard ability you do not possess, such as the Elemental Wall dealing damage equal to your Elemental Blast, it is not a valid choice for the character to select with this ability. Advanced: You may select this ability multiple times. Each time, you learn a new Conjuration spell and use the skill and ability score chosen to cast it.",
  "Dabbler": "Upon gaining your specialization, you may gain a Subclass Power from any subclass whose abilities you could use. Eg: If you can have a companion creature, you may take powers that affect your companion creature. After choosing the subclass whose power you may take, you may take additional powers from that class as if they were your own. You must still be able to use these powers as normal.",
  "Deviant Magic": "Choose one General Skill that you are trained in. You may use your Spellcraft check instead of the bonus for the chosen skill when making skill checks of that type. As with most powers, you may only select this power one time.",
  "Devotee": "Choose a dedication from the list below and gain the associated bonus. Ferocity: Gain a +2 bonus on all initiative checks and Reflex saves. Savagery: Gain a +2 bonus on all damage rolls and Fortitude saves. Valor: Gain a +2 bonus on all attack rolls and Will saves.",
  "Dodger": "Gain the Dodge feat. You may use this ability once per turn without spending your reaction.",
  "Elemental Blast": "Gain an Elemental Blast attack that deals damage of the same type as your creature. Use your Charisma modifier instead of your Intelligence modifier when calculating this ability.",
  "Elemental Carnage": "Your elemental blast increases in damage. The damage is now calculated as 1d6 per point of your intelligence modifier (minimum +5).",
  "Elemental Defense": "You can absorb damage that matches the type of your elemental. This amount is equal to your level + your Charisma modifier. If you are hit with elemental damage of that type, you heal the amount of damage dealt to you. This ability resets the next morning at sunrise. Any damage beyond what you can absorb damages you normally.",
  "Elemental Initiate": "Deal one type of elemental damage on all attacks. The type of damage is chosen when you gain this power. The amount of damage is equal to your level.",
  "Elemental Power": "Gain a power from the list below. This can be selected multiple times, each time granting a new power. Lightning Dash: When taking a step action, you may move an additional 5 feet as you jolt forward with electricity. Seismic Sense: You gain tremorsense out to a range of 20 feet. Spark of Energy: You gain advantage on all initiative checks. Ice Shield: As an action, you may summon a shield of your choice made of ice. It becomes a puddle of water in 1 minute unless you are in a frozen environment. Dissolve: You may place your hands on a structure and cause it to take acid damage equal to your level every round, which bypasses damage reduction.",
  "Elemental Storm": "As a two-action activity, you create a storm that lasts for a number of rounds equal to your Wisdom modifier. As an action after using this power, you can extend the duration by one round. Create a storm that deals damage equal to your Wisdom modifier in a number of hexes equal to your character level. Your targets make a Reflex save opposed by Nature check. Choose an element from the list below each time you make a storm: Fire, Cold, Acid, Electricity, Sonic.",
  "Elemental Strike": "You gain the ability to enhance your attacks with elemental damage. You may spend two actions to attack with a weapon, dealing damage equal to the amount you would normally deal with the weapon plus the amount from your elemental blast. You must be proficient with the weapon used. You may add this additional damage to any attacks you make as reactions. You do not provoke reactions because of your spellcasting when using this ability.",
  "Enhance Ability": "As an action, give yourself an Ability Score Boost of your choice. This effect lasts for a number of minutes equal to your Nature skill. You may also touch a chosen creature to grant them this benefit. The Aura Mastery feat allows you to use this ability on the same number of willing creatures within the same range that your Aura Mastery feat allows, including yourself.",
  "Entangle": "As a two-action activity, you summon plants that last for a number of rounds equal to your Wisdom modifier. As an action after using this power, you can extend the duration by one round. Cause a form of plant or fungus to expand in a certain area, covering a number of hexes equal to your Wisdom modifier. Choose one type of growth (Thorns, Sickening, Thirsting); creatures in an affected hex make a save opposed by your Nature check or suffer bleed/sickened/nonlethal damage and become entangled for 1 round.",
  "Ethereal Might": "As a two-action activity, you cause a target creature to take nonlethal damage equal to your level + your Intelligence modifier. The creature makes an opposing Fortitude save. Range: a number of hexes equal to your Spellcraft modifier. Degrees of Success — Critical Success: nonlethal damage + the creature loses an action next turn. Success: nonlethal damage. Partial Success: 1 point nonlethal. Failure: no damage. Critical Failure: no damage and you lose your next reaction.",
  "Exemplary Companion": "Your Companion gains a General Feat of your choice.",
  "Expanded Blast": "A number of contiguous hexes equal to per level + the Arcanist's Intelligence modifier are affected by elemental blast instead of one target.",
  "Expert Shot": "Gain one of the benefits listed below. Cover fire: As a three-action activity, attack a number of targets equal to your level within range, all at disadvantage dealing minimum damage (no MSP). Dedicated target: Gain the Champion's Challenge ability. Switch-hitter: Your ranged weapon counts as melee or ranged as needed; gain the Bowstaff feat without spending an action adjusting grip. Weapon of choice: Choose one ranged weapon; it deals +2 damage and can always be repaired.",
  "Extraordinary Creature": "The creature gains two ASBs to any scores and one ASB to intelligence or wisdom.",
  "Familiar Spell": "The creature gains access to a single spell from the Wizard list which it can cast. It uses its charisma and its arcane skill instead of intelligence and the spellcraft skill. The level of the Archon is used to determine the caster level of the spell.",
  "Favored Enemy": "Choose one stance. You get a +2 on attack rolls and reflex saves against any character using that stance.",
  "Final Aspect": "You gain one of the Aspects that your companion can choose. Additionally, your companion gains two of the benefits listed below: 10 skill ranks to apply to any number of skills; 20 bonus HP; a static +5 damage bonus on all attacks; 4 Ability Score Increases.",
  "Fine Particles": "Dirt, sand, or any other material if it has been ground into fine pieces.",
  "Flash": "As an action, your familiar teleports to a hex within 20 feet of you. Any creatures adjacent to that hex, excluding yourself, must make a Fortitude save or else be blinded as the creature appears.",
  "Fluids": "Water in all of its forms and other liquids that are not components or byproducts of living creatures.",
  "Flurry": "If you spend two actions making two attacks, you may make a 3rd attack as a free action. MSP applies to this attack.",
  "Forbidden Practices": "By spending one minute enacting a ritual, you may raise the dead to fight for you. You take 4 points of nonlethal damage each use, plus the point from exerting yourself. You gain a companion creature for a number of hours equal to your Nature skill, built as the Archon subclass gets but using the Undead type; only one at a time. Undead creatures gain DR 2, do not breathe/eat/sleep, have blindsight 30 ft, are immune to nonlethal damage and Fortitude-save effects (no Constitution score), start with 20 HP + 2 per necromancer level, cannot be healed by potions/magic, and can only be reduced to 1 HP unless the hit deals elemental or force damage.",
  "Fortune": "As a reaction, add 1d6 to any saving throw after the rolls are made.",
  "Gems": "Diamonds, rubies, etc.",
  "General Skill Proficiency": "This power can be selected more than once. Each time you select it, you gain proficiency in an additional general skill.",
  "Ghost-whisperer": "You may use your Spellcraft modifier on all Diplomacy, Bluff, and Intimidate checks instead of the relevant modifier. When interacting with incorporeal creatures, you gain advantage on Spellcraft checks made to influence them.",
  "Hybrid Form": "You embody the features of one of your known materials. The material chosen affects the outcome of this decision. Your appearance remains the same outwardly. Once chosen, this decision is permanent.",
  "Identical Swarm": "As a two-action activity, you may direct all of the creatures in your swarm to take the same action. All creatures must have the powers necessary to take that action and they may each use up to three actions to follow this direction.",
  "Illusionist": "If a creature fails a will save against one of your illusion spells, they take the illusion one step further. If you cause the spell to do something that could be harmful to the creature (such as attacking them), they take one point of nonlethal damage per caster level out of fear.",
  "Inspiration": "You may spend an action to grant a number of creatures equal to your Charisma modifier a bonus equal to your level on any one roll they make before the beginning of your next turn. You can not affect yourself with this power, but you can affect your companion creatures.",
  "Magic Trick": "Use your Spellcraft skill bonus on two chosen combat skills instead of the normal bonus. You may use these combat skills at the same range you can use your Elemental Blast ability.",
  "Magical Healing": "One action: Heal yourself of 1d8 + your Intelligence modifier; take 1 nonlethal damage. Two actions: Heal a touched creature of 1d8 + Intelligence modifier; take 1 nonlethal. Three actions: Heal a touched creature; with the Aura Mastery feat, make a Spellcraft check to heal several creatures within Elemental Blast range (max = your Intelligence modifier): 20+ any number up to your Int mod, 15+ two creatures, 10 or lower one creature. Healing does not affect nonlethal damage.",
  "Magical Savant": "Learn the Advanced ability for any spell that you know.",
  "Martial Prowess": "Gain Weapon Specialization with two different weapon groups of your choice.",
  "Master's Reach": "Your companions traverse your limbs, launching off them to attack nearby creatures. If any of your companion creatures are adjacent to you, your reach is added to their reach for the purpose of making attacks.",
  "Material Spray": "As a two-action activity, you may launch a spray attack with one of your known materials. You are proficient with this attack. Spray attacks are melee weapons that deal damage within the listed range, cannot be countered or redirected, and only require one attack roll against all targets. Effect: damage equal to your Launch Material ability; the length is a number of squares equal to half your character level, rounded down (10 feet at level 5).",
  "Metal": "Gain DR equal to your level. This stacks with all other forms of DR. You can no longer be disarmed, as metal objects fuse to you at your will.",
  "Metals": "All metallic substances, either worked or unworked.",
  "Mirror Image": "Create 1d4 mirror images of yourself as a two-action activity that provokes reactions. These images cause your attackers to not be able to locate you and they last for one minute. Whenever you are attacked and the attack succeeds, the attacker must roll (1d2–1d5 based on images remaining) and roll a 1 to actually hit you.",
  "Natural Healer": "You gain the healing power from the Shaman, but you use your Wisdom instead of Intelligence and your Nature skill instead of Spellcraft.",
  "Natural Remedy": "You get the Potion Brewer feat, but you use your Nature skill instead of the Craft: Potions skill. The rest of the feat's abilities still work as written and you still need to acquire the necessary material components.",
  "Natural Storm": "As a two-action activity, you create a storm that lasts for a number of rounds equal to your Wisdom modifier (extendable one round per action). Choose Sand, Wind, Rain, Ice, Smoke, or Sun; creatures in the affected hexes make the relevant save opposed by your Nature check each round or suffer that element's effect (nonlethal damage, grappled, prone, blinded, sickened, reduced visibility/movement).",
  "Nature Focus": "Gain one of the Aspects available to a Companion Creature for a number of minutes equal to your Nature skill. You take 1 point of nonlethal damage when the effect wears off. You cannot choose the Sorcerous Aspect.",
  "New Feature": "Your Companion gains a new Feature. This can be selected multiple times, each time granting the Companion a new Feature.",
  "New Material": "You can redistribute an additional type of material. You may select this power multiple times.",
  "Oozes": "Cooking oils, crude oil, and other viscous liquids.",
  "Organic Matter": "Material from living organisms and their byproducts. You are not able to transmute these materials if they are still alive or are attached to a living being.",
  "Paired Strikes": "As an action, you and your companion creature can each make a strike against a target within reach of both of you. MSP applies to these strikes as normal. Your creature makes this strike as a free action.",
  "Paragon": "Gain 4 ability score boosts. Gain a new Combat Feat. Gain a new General Feat.",
  "Personal Style": "Gain one of the abilities listed under the Style: Spell Combat feat or the Style: Arcane Combat feat. You may use your Spellcraft skill and your intelligence modifier instead of your Arcane skill and your charisma modifier if you choose an Arcane Combat ability.",
  "Primal Shape": "As a two-action activity, you turn into a different creature for a number of minutes equal to your Nature skill. You can become any small, medium, or large creature, applying the relevant ability score changes. You gain one of the creature's movement types (and may raise your land speed by 10 ft) plus any natural attacks. You take 1 point of nonlethal damage when the effect wears off.",
  "Primal Speaker": "You can use the Command spell, using your Nature skill and your Wisdom modifier instead of Spellcraft and Intelligence. This ability does not provoke reactions.",
  "Rapid Reload": "You only need 2 actions to reload a firearm or crossbow.",
  "Redirect Energy": "Gain the Redirect Energy feat. Use your Nature skill instead of your Arcane skill.",
  "Redistribute Complex Object": "When crafting objects using your Nature skill, you can make objects using only one material even if multiple would normally be required (e.g. a metal shield with leather straps needs only Metal redistribution).",
  "Relentless": "Gain the Relentless feat. You may use this ability once per turn without spending your reaction.",
  "Sage": "You gain the ability to use one of the aspects available through the Divine Curse feat. As an action, make an attack roll with a combat skill of your choice against a target within reach; consult the feat's degrees of success. The target suffers the combat skill's and the Curse's effects. This does not provoke reactions. Use your Wisdom modifier to calculate the duration if necessary.",
  "Sharpshooter": "Gain Weapon Focus and Weapon Specialization with one kind of firearm or ranged weapon.",
  "Shot On The Run": "As an action, you may make an attack with a proficient ranged weapon and take a stride or step action. The MSP applies to all attacks this round as normal.",
  "Sniper": "By spending an additional action on your attack, you may double the range of your weapon and deal additional damage equal to your level.",
  "Special Delivery": "When casting a spell that targets another creature, you may use a weapon or object in hand to affect the target. Whether or not you deal damage, you must exceed the target's reflex save with an attack roll. If proficient with the item, your attack bonus is calculated as a normal weapon attack; if not, your bonus equals your dexterity modifier.",
  "Specter": "Instead of dealing elemental damage with your arcane blast, you may choose to deal force damage.",
  "Stone": "All types of rock including coal, granite, shale, and more.",
  "Storm Brewer": "When using a storm power, add 2 to the result of all nature checks you make.",
  "Supernatural Creature": "The Intelligence of the creature becomes 10 (or increases by one step if already at 10 or higher) and it gains Arcane as a class skill.",
  "Surge": "As an action, you increase any two physical ability scores for 1 minute. You also take a penalty on one mental ability score for 1 minute. You cannot use any skills associated with the penalized ability score for 10 minutes after, and take one point of nonlethal damage every time you activate this ability. You can only use this ability once per minute.",
  "Swarm Assault": "Your Companions may make a combined attack. Each spends actions as normal, directing their attacks against the same target. If any one succeeds, the target takes damage as if hit by all of them.",
  "Swift Redistribution": "You are able to use your transmutation ability with a single action instead of using two actions.",
  "Synergist": "You may use two different elements simultaneously when dealing damage with elemental blast. The damage is split evenly between the two elements, or as close to it as possible in the case of odd numbers.",
  "Temporary Shift": "You are able to cause one of your known materials to temporarily become another known material. You must use roughly the same amount of material (by weight or size) regardless of the materials chosen. This lasts for a number of minutes equal to your Nature skill.",
  "Transmuter": "You learn a single Transmutation spell of your choice. Use your Nature skill and your Wisdom modifier instead of your Spellcraft skill and your Intelligence modifier. The duration for this spell is double what it normally would be. Advanced: You learn another Transmutation spell, following the same changes.",
  "Trick Shot": "As a three-action activity, you may wound a creature with a targeted attack. Apply one penalty if you hit: Leg shot (target loses 10 ft move speed for rounds equal to your level), Arm shot (target cannot use the hit arm for rounds equal to your level), Head shot (deal 1d6 bleed damage in addition to any normal bleed).",
  "Varied Swarm": "If you spend three consecutive actions directing your companion creatures, you may make a stride or step as a free action.",
  "Vast Manufacturing": "Your redistribution uses 5-foot cubes of material, regardless of their weight.",
  "Virtuoso": "You gain advantage on all rolls with one skill of your choice.",
  "Weapon Expert": "Gain Weapon Focus with two different weapon groups of your choice.",
  "Weapon Mastery": "You gain the ability to apply one of the weapon properties below to any weapon that you wield (not firearms or special weapons). You cannot apply the same property twice. Properties: Expanded critical, Powerful critical, Nonlethal, Additional range, Engineered.",
  "Weapon Training": "Gain proficiency with any two weapon groups of your choice.",
};

/** Effect text for a class power/specialization by name (case-insensitive), or undefined if not captured.
 *  The builder preview + sheet feature bodies read through this so a listed power shows what it does. */
export function igClassPowerEffect(name: string | null | undefined): string | undefined {
  if (!name) return undefined;
  const key = name.trim().toLowerCase();
  // The specialization labels above carry a parenthetical gloss — match on the leading name too.
  const bare = key.replace(/\s*\(.*$/, '').trim();
  for (const [k, v] of Object.entries(IG_CLASS_POWER_EFFECTS)) {
    const kk = k.toLowerCase();
    if (kk === key || kk === bare) return v;
  }
  return undefined;
}
