...
const LEVEL_1_MORE: SpellDef[] = [
  ...
  { key: 'chromatic-orb', name: 'Chromatic Orb', level: 1, school: 'Evocation', castTime: '1 action', range: '90 feet', components: 'V, S, M', material: 'a diamond worth 50+ GP', duration: 'Instantaneous', classes: ['Sorcerer', 'Wizard'],
    summary: 'Ranged spell attack for 3d8 damage of a type you choose: acid, cold, fire, lightning, poison, or thunder.', higher: '+1d8 per slot level above 1st.', source: PHB },
...
const LEVEL_2_MORE: SpellDef[] = [
  ...
  { key: 'prayer-of-healing', name: 'Prayer of Healing', level: 2, school: 'Abjuration', castTime: '10 minutes', range: '30 feet', components: 'V', duration: 'Instantaneous', classes: ['Cleric', 'Paladin'],
    summary: 'Up to five creatures each regain 2d8 + your spellcasting ability modifier hit points.', higher: '+1d8 per slot level above 2nd.', source: PHB },
  ...
  { key: 'shatter', name: 'Shatter', level: 2, school: 'Evocation', castTime: '1 action', range: '60 feet', components: 'V, S, M', material: 'a chip of mica', duration: 'Instantaneous', classes: ['Bard', 'Sorcerer', 'Warlock', 'Wizard'],
    summary: 'A 10-foot-radius sphere of noise: Constitution save for 3d8 thunder damage, half on a success. Inorganic creatures have disadvantage.', higher: '+1d8 per slot level above 2nd.', source: PHB },
...
const LEVEL_3_MORE: SpellDef[] = [
  ...
  { key: 'vampiric-touch', name: 'Vampiric Touch', level: 3, school: 'Necromancy', castTime: '1 action', range: 'Self', components: 'V, S', duration: '1 minute', concentration: true, classes: ['Warlock', 'Wizard'],
    summary: 'Melee spell attack for 3d6 necrotic damage; you regain half the damage dealt as hit points.', higher: '+1d6 per slot level above 3rd.', source: PHB },
];
...
const LEVEL_1_C: SpellDef[] = [
  ...
  { key: 'arms-of-hadar', name: 'Arms of Hadar', level: 1, school: 'Conjuration', castTime: '1 action', range: 'Self (10-foot radius)', components: 'V, S', duration: 'Instantaneous', classes: ['Warlock'],
    summary: 'Strength save or 2d6 necrotic damage and no reactions until its next turn; half damage on a success.', higher: '+1d6 per slot level above 1st.', source: PHB },
  ...
  { key: 'divine-smite', name: 'Divine Smite', level: 1, school: 'Evocation', castTime: '1 bonus action', range: 'Self', components: 'V', duration: 'Instantaneous', classes: ['Paladin'],
    ...
    editionNote: 'In 2024 Divine Smite is a SPELL cast as a Bonus Action, not a free class resource — so it uses a slot and obeys the one-spell-per-turn rules.', source: PHB },
  { key: 'ensnaring-strike', name: 'Ensnaring Strike', level: 1, school: 'Conjuration', castTime: '1 bonus action', range: 'Self', components: 'V', duration: '1 minute', concentration: true, classes: ['Ranger'],
    summary: 'Your next hit wraps the target in thorns: Strength save or Restrained, taking 1d6 piercing at the start of each of its turns.', higher: '+1d6 per slot level above 1st.', source: PHB },
  ...
  { key: 'hail-of-thorns', name: 'Hail of Thorns', level: 1, school: 'Conjuration', castTime: '1 bonus action', range: 'Self', components: 'V', duration: '1 minute', concentration: true, classes: ['Ranger'],
    summary: 'Your next ranged weapon hit bursts into thorns: creatures near the target make a Dexterity save for 1d10 piercing, half on a success.', higher: '+1d10 per slot level above 1st.', source: PHB },
  { key: 'hellish-rebuke', name: 'Hellish Rebuke', level: 1, school: 'Evocation', castTime: '1 reaction', range: '60 feet', components: 'V, S', duration: 'Instantaneous', classes: ['Warlock'],
    summary: 'Cast when damaged by a creature you can see: Dexterity save for 2d10 fire damage, half on a success.', higher: '+1d10 per slot level above 1st.', source: PHB },
  ...
  { key: 'ray-of-sickness', name: 'Ray of Sickness', level: 1, school: 'Necromancy', castTime: '1 action', range: '60 feet', components: 'V, S', duration: 'Instantaneous', classes: ['Sorcerer', 'Wizard'],
    summary: 'Ranged spell attack for 2d8 poison damage; on a hit the target makes a Constitution save or gains the Poisoned condition until your next turn ends.', higher: '+1d8 per slot level above 1st.', source: PHB },
  { key: 'searing-smite', name: 'Searing Smite', level: 1, school: 'Evocation', castTime: '1 bonus action', range: 'Self', components: 'V', duration: '1 minute', concentration: true, classes: ['Paladin'],
    summary: 'Your next melee hit deals an extra 1d6 fire damage and sets the target burning for 1d6 per turn until it succeeds on a Constitution save.', higher: '+1d6 per slot level above 1st.', source: PHB },
  ...
  { key: 'thunderous-smite', name: 'Thunderous Smite', level: 1, school: 'Evocation', castTime: '1 bonus action', range: 'Self', components: 'V', duration: '1 minute', concentration: true, classes: ['Paladin'],
    summary: 'Your next melee hit deals an extra 2d6 thunder damage; Strength save or the target is pushed 10 feet and knocked Prone.', higher: '+1d6 per slot level above 1st.', source: PHB },
  ...
  { key: 'witch-bolt', name: 'Witch Bolt', level: 1, school: 'Evocation', castTime: '1 action', range: '30 feet', components: 'V, S, M', material: 'a twig struck by lightning', duration: '1 minute', concentration: true, classes: ['Sorcerer', 'Warlock', 'Wizard'],
    summary: 'Ranged spell attack for 2d12 lightning damage; on later turns you can use an action to deal the damage again automatically.', higher: '+1d12 per slot level above 1st.', source: PHB },
  { key: 'wrathful-smite', name: 'Wrathful Smite', level: 1, school: 'Necromancy', castTime: '1 bonus action', range: 'Self', components: 'V', duration: '1 minute', concentration: true, classes: ['Paladin'],
    summary: 'Your next melee hit deals an extra 1d6 psychic damage; Wisdom save or the target gains the Frightened condition.', higher: '+1d6 per slot level above 1st.', source: PHB },
];
...
const LEVEL_2_C: SpellDef[] = [
  ...
  { key: 'branding-smite', name: 'Branding Smite', level: 2, school: 'Transmutation', castTime: '1 bonus action', range: 'Self', components: 'V', duration: '1 minute', concentration: true, classes: ['Paladin'],
    summary: 'Your next weapon hit deals an extra 2d6 radiant damage and makes the target shed dim light, unable to benefit from being Invisible.', higher: '+1d6 per slot level above 2nd.', source: PHB },
  { key: 'cloud-of-daggers', name: 'Cloud of Daggers', level: 2, school: 'Conjuration', castTime: '1 action', range: '60 feet', components: 'V, S, M', material: 'a sliver of glass', duration: '1 minute', concentration: true, classes: ['Bard', 'Sorcerer', 'Warlock', 'Wizard'],
    summary: 'A 5-foot cube of spinning blades deals 4d4 slashing damage to a creature entering it or starting its turn there.', higher: '+2d4 per slot level above 2nd.', source: PHB },
  ...
  { key: 'flame-blade', name: 'Flame Blade', level: 2, school: 'Evocation', castTime: '1 bonus action', range: 'Self', components: 'V, S, M', material: 'sumac leaf', duration: '10 minutes', concentration: true, classes: ['Druid'],
    summary: 'A scimitar of fire you can attack with as a melee spell attack for 3d6 fire damage; it sheds bright light.', higher: '+1d6 per two slot levels above 2nd.', source: PHB },
  { key: 'flaming-sphere', name: 'Flaming Sphere', level: 2, school: 'Conjuration', castTime: '1 action', range: '60 feet', components: 'V, S, M', material: 'tallow, brimstone, and iron dust', duration: '1 minute', concentration: true, classes: ['Druid', 'Wizard'],
    summary: 'A 5-foot sphere of flame you move 30 feet as a Bonus Action; a creature it touches makes a Dexterity save for 2d6 fire damage, half on a success.', higher: '+1d6 per slot level above 2nd.', source: PHB },
  ...
  { key: 'heat-metal', name: 'Heat Metal', level: 2, school: 'Transmutation', castTime: '1 action', range: '60 feet', components: 'V, S, M', material: 'a piece of iron and a flame', duration: '1 minute', concentration: true, classes: ['Bard', 'Druid'],
    summary: 'A metal object glows red-hot for 2d8 fire damage; a creature holding it must make a Constitution save or drop it.', higher: '+1d8 per slot level above 2nd.', source: PHB },
  ...
  { key: 'melfs-acid-arrow', name: "Melf's Acid Arrow", level: 2, school: 'Evocation', castTime: '1 action', range: '90 feet', components: 'V, S, M', material: 'powdered rhubarb leaf and an adder’s stomach', duration: 'Instantaneous', classes: ['Wizard'],
    summary: 'Ranged spell attack for 4d4 acid damage, plus 2d4 at the end of the target’s next turn; half damage even on a miss.', higher: '+1d4 per slot level above 2nd.', source: PHB },
  ...
  { key: 'spike-growth', name: 'Spike Growth', level: 2, school: 'Transmutation', castTime: '1 action', range: '150 feet', components: 'V, S, M', material: 'seven thorns', duration: '10 minutes', concentration: true, classes: ['Druid', 'Ranger'],
    summary: 'A 20-foot radius becomes difficult terrain dealing 2d4 piercing damage for every 5 feet a creature moves through it.', source: PHB },
