...
import { WARLOCK_2014, WARLOCK_SUBCLASSES_2014 } from './dnd5e-2014/warlock';
import { BARD_2014, BARD_SUBCLASSES_2014 } from './dnd5e-2014/bard';
import { CLERIC_2014, CLERIC_SUBCLASSES_2014 } from './dnd5e-2014/cleric';
...
const DND5E_2014_CLASSES: ClassDefinition[] = [
  ...
  WARLOCK_2014, BARD_2014, CLERIC_2014,
];
const DND5E_2014_SUBCLASSES: SubclassDefinition[] = [
  ...
  ...SORCERER_SUBCLASSES_2014, ...WARLOCK_SUBCLASSES_2014, ...BARD_SUBCLASSES_2014, ...CLERIC_SUBCLASSES_2014,
];
